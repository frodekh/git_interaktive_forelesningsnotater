...
\begin{frame}
\label{front}
\center{\Large \textcolor{darkscarlet}{\bf AST2000 Del 2B forlesning 1 av 2\\Interaktive forelesningsnotater}}\\
\vspace*{1cm}
...
\item Det er mange spørsmål/grubliser underveis, sett dere selv en tidsgrense, 1-2 minutter på de korte, 4-5 minutter på de lenger. Ha en alarm ved siden av, ellers kommer dere til å bruke alt for langt tid. Har dere ikke fått det til etter kort tid, gå videre, se svaret og lær!
...
\centerline{\includegraphics[scale=0.17]{hellning.png}}
...
\hyperlink{td3a}{\choicebutton{det er en horisontal linje}}
\hyperlink{td3a}{\choicebutton{det er en vertikal linje}}
\hyperlink{td3a}{\choicebutton{linja danner 22.5 grader med x-aksen}}
\hyperlink{td3a}{\choicebutton{linja danner 30 grader med x-aksen}}
\hyperlink{td3b}{\choicebutton{linja danner 45 grader med x-aksen}}
\hyperlink{td3a}{\choicebutton{linja danner 67.5 grader med x-aksen}}
}


\colchoiceframe{td3a}{td3}{0}{black}{\Huge
...
\colfullframe{td3b}{td3}{td4}{-1}{yellow}{\large
...
\fullframe{td4}{td3b}{td5}{0}{\Huge
\centerline{\includegraphics[scale=0.6]{cowboy.png}}
...
%\centerline{\includegraphics[scale=0.3]{}}
...
\hyperlink{td5a}{\choicebutton{Bare B}}
\hyperlink{td5a}{\choicebutton{Bare C}}
\hyperlink{td5a}{\choicebutton{Bare D}}
\hyperlink{td5b}{\choicebutton{B og C}}
\hyperlink{td5a}{\choicebutton{B og D}}
\hyperlink{td5a}{\choicebutton{C og D}}
\hyperlink{td5a}{\choicebutton{alle tre}}
}

\colchoiceframe{td5a}{td5}{0}{black}{\huge
...
\colfullframe{td5b}{td5}{td6}{-1}{yellow}{\Huge
...
\fullframe{td6}{td5b}{td7}{0}{\Large
...
\centerline{\includegraphics[scale=0.22]{cars.png}}
}
...
\hyperlink{td11b}{\choicebutton{1=konstant fart, 2=akselererte mest,3=skiftet retning}}
\hyperlink{td11a}{\choicebutton{2=konstant fart, 3=akselererte mest,1=skiftet retning}}
\hyperlink{td11a}{\choicebutton{3=konstant fart, 1=akselererte mest,2=skiftet retning}}
\hyperlink{td11a}{\choicebutton{2=konstant fart, 1=akselererte mest,3=skiftet retning}}
\hyperlink{td11a}{\choicebutton{3=konstant fart, 2=akselererte mest,1=skiftet retning}}
\hyperlink{td11a}{\choicebutton{1=konstant fart, 3=akselererte mest,2=skiftet retning}}
\hyperlink{td11a}{\choicebutton{1=konstant fart, 2=akselererte mest og skiftet retning}}
\hyperlink{td11a}{\choicebutton{2=konstant fart, 1=akselererte mest og skiftet retning}}
\hyperlink{td11a}{\choicebutton{3=konstant fart, 1=akselererte mest og skiftet retning}}
}


\colchoiceframe{td11a}{td11}{0}{black}{\huge
...
\colfullframe{td11b}{td11}{pause}{-1}{yellow}{\Huge
...
\begin{frame}
\label{pause}
\hyperlink{td11b}{\pagebutton{\small Forrige side}}
{\huge
\centerline{Kaffe?}
...
\fullframetxt{td12}{td11b}{td13}{0}{Jeg har tegnet diagrammet!}{
...
\fullframe{td15}{td14}{nytema2}{0}{\Huge
...
\fullframe{td16}{td15}{td16b}{0}{\label{maksaldring}\large
...
\colfullframe{td16b}{td16}{td17}{0}{red}{\huge
...
\fullframe{td17}{td16b}{td18}{0}{\huge
Fikk du:
\[
...
\centerline{\includegraphics[scale=0.15]{romskipene1.png}}
...
\centerline{\includegraphics[scale=0.13]{romskipene2.png}}
...
\centerline{\includegraphics[scale=0.15]{cars.png}}
...
\colfullframe{td25c}{td25b}{td25d}{0}{red}{\Huge
...
\fullframe{td25d}{td25c}{td26}{0}{\Huge
...
\vspace*{0.5cm}
\hyperlink{nytema3}{\pagebutton{Ok, jeg er klar for 4D(X?)-matematikk... }}
\end{frame}
}
...
\fullframe{vv6}{vv5}{oppsummering0}{0}{
