...
\newcommand{\clastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/171403}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\headlinebutton{\headline}\padletbutton\\}
\newcommand{\dlastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/171403}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\headlinebutton{\headline}\padletbutton\\}
...
\newcommand{\clastpagebuttoncr}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/171403}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\\\headlinebutton{\headline}\padletbutton\\}
\newcommand{\dlastpagebuttoncr}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/171403}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\\\headlinebutton{\headline}\padletbutton\\}
...
\begin{frame}
\label{front}
\center{\Large \textcolor{darkscarlet}{\bf AST2000 Del 2B forlesning 2 av 2\\Interaktive forelesningsnotater}}\\
\vspace*{1cm}
...
\href{https://nettskjema.no/a/171389}{\choicebutton{Nei}}\ \ \ \ \hyperlink{brainstormdone}{\choicebutton{Ja}}\\
...
\fullframetxt{vv2}{vv1}{vv3}{0}{\small Trykk her etter at du har tenkt gjennom hva en 4-vektor er}{\large
...
\colfullframe{vv3}{vv2}{vv4}{0}{red}{\Huge
...
\fullframetxt{vv4}{vv3}{vv5}{0}{Jeg har tenkt godt gjennom problemstillingen}{\Large
...
\colfullframe{vv5}{vv4}{vv6}{0}{red}{\Large
...
\fullframe{vv8}{vv7}{nytema2}{0}{\huge
...
\]
\hyperlink{hast2b}{\choicebutton{det høres ut som en fornuftig generalisering...}}
\hyperlink{hast2a}{\choicebutton{Næææææææ.....}}
}

\colfullframe{hast2a}{hast2}{hast3}{0}{black}{\Huge
...
\colfullframe{hast2b}{hast2}{hast3}{-1}{black}{\Huge
...
\colfullframe{hast3}{hast2}{hast4}{0}{black}{\Large
\textcolor{yellow}{
\[
V_\mu=\frac{dx_\mu}{dt}
\]
...
\colfullframe{hast4}{hast3}{hast5}{0}{red}{\Huge
Et hint: kan vi derivere med hensyn på {\bf en annen tid} enn $t$? Ikke bla videre før du har et forslag!}

\fullframetxt{hast5}{hast4}{hast6}{0}{Dette bør du kunne svare på}{
Hva med {\bf egentid $\tau$? Husker du hva det var?}\pagequestion{hast5b}{javisst ja (evt. jeg repeterte nå)}{-1}
Var ikke det armbåndsurtid?\pagequestion{hast5c}{jovisst!}{0}
Altså tiden målt på en klokke som står fast på objektet som vi ser på, altså det objektet vi måler hastigheten til. Men er det en invariant størrelse da? ({\bf det må del vel være for at vi skal dele det med en 4-vektor!?)}\pagequestion{hast5d}{det var det og jeg husker hvorfor (evt. jeg repeterte nå)}{0}
...
\colfullframe{hast6}{hast5}{hast7}{1}{red}{\Huge
Et hint: hva betyr invariant? Dette {\bf må} du ha kontroll på nå, hvis ikke spør!}

\fullframe{hast7}{hast6}{hast8}{0}{\huge
...
\]
der $t$ er tiden målt i det samme referansesystemet som måler posisjonsvektoren $x_\mu$, og hastighetskomponentene er hastighet også målt i dette referansesystemet?
}
...
\]
der $v$ er fart målt i det samme referansesystemet som måler posisjonsvektoren $x_\mu$? Og $\vec{v}$ er rett og slett den 3-dimensjonale hastighetsvektoren også målt i dette referansesystemet.
}
...
V=\sqrt{V_\mu V^\mu}
\]
Merk deg en $\mu$-indeks er nede og en er oppe for å indikere {\bf skalarprodukt.} \textcolor{red}{Husker du hvordan man beregner skalarproduktet?} Gjør et forsøk nå på å finne en verdi for $V$!
}
...
\fullframe{hast14}{hast13}{nytema2b}{0}{\Huge
...
\colfullframe{hast16}{hast15}{hast17}{1}{red}{\Huge
...
\fullframe{hast17}{hast16}{hast18}{0}{
...
\centerline{\includegraphics[scale=0.27]{klassrel11.png}}
...
\centerline{\includegraphics[scale=0.27]{klassrel2.png}}
...
\fullframetxt{hast20}{hast19}{nytema3}{0}{\footnotesize Neste side}{\footnotesize
\centerline{\includegraphics[scale=0.25]{klassrel2.png}}
Får du at
\[
v'_x=\frac{v_x-v_\mathrm{rel}}{1-v_\mathrm{rel}v_x}
\]
...
\fullframetxt{pe8}{pe7}{pause2}{0}{\small Jeg har sett videoen og har enda ikke kommet meg over sjokket!}{\large
...
\fullframe{pe12}{pe12x}{pe13}{0}{
La du merke til noe rart i dette uttrykket?
\[
E_\mathrm{relativistisk}^2-p_\mathrm{relativistisk}^2=m^2
\]
\pagequestion{pe12b}{Tjaaaaaaa...}{-1}
Hva med enhetene i denne likningen da?
\pagequestion{pe12c}{Dæggern... her varre no'rart...}{0}
...
\centerline{\includegraphics[scale=0.22]{klassrel2.png}}
...
\fullframetxt{pe14}{pe13}{pe15}{0}{Dette har jeg gjort før, så det kan jeg!}{
\centerline{\includegraphics[scale=0.22]{klassrel2.png}}
...
\colfullframe{pe15}{pe14}{pe16}{0}{red}{\Huge
...
\fullframe{pe17}{pe16}{pe17b}{0}{\Huge
...
\fullframetwo{pe17b}{pe17}{pe17c}{0}{\footnotesize
...
\centerline{\includegraphics[scale=0.3]{nucleus1.png}}\\
...
\centerline{\includegraphics[scale=0.3]{nucleus2.png}}\\
Partiklene går her i nøyaktig motsatt regning med samme hastighet $v$. Etter litt tid vil de selvfølgelig bli dradd tilbake igjen av den sterke kjernekrafta. Sett opp 4-bev.mengdevektoren $P_\mu(1)$ og $P_\mu(2)$ for begge partiklene hver for seg og sum så disse sammen til $P_\mu(M)$ for hele atomkjernen.\pagequestion{pe17x}{Ok, har gjort det!}{-1} Fikk du $P_\mu(1)=(\gamma m, \gamma mv)$ og $P_\mu(2)=(\gamma m, -\gamma mv)$??? Og for kjernen $P(M)=(2m\gamma,0)$??
}

\fullframetwo{pe17c}{pe17b}{pe18}{1}{
\centerline{\includegraphics[scale=0.35]{nucleus2.png}}
Hvordan finner man massen av en partikkel med 4-bev.mengdevektor $P_\mu$??\pagequestion{pe17xx}{\small Det har vi jo akkurat lært...}{-2} Javisst ja, man tar skalarprodukt, $M=\sqrt{P_\mu(M)P^\mu(M)}$. Så hva blir totalmassen til atomkjernen? \pagequestion{pe17xxx}{\small Regne, regne, regne, det blir...}{0}
\[
...
\centerline{\includegraphics[scale=0.14]{detonator.png}}
