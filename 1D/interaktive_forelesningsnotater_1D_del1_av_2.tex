...
\begin{frame}
\label{front}
\center{\Large \textcolor{darkscarlet}{\bf AST2000 Del 1D\\Interaktive forelesningsnotater: forelesning 1 av 2}}\\
\vspace*{1cm}
...
\href{https://nettskjema.no/a/155782}{\choicebutton{Nei}}\ \ \ \ \hyperlink{brainstormdone}{\choicebutton{Ja}}\\
...
\includegraphics[scale=0.4]{1d3_1.png}\\
{\bf Du skal altså ikke bruke tall nå, kun diskutere \textcolor{red}{hvordan} du vil løse oppgaven}.
...
\includegraphics[scale=0.4]{1d3_2.png}\\
\column{0.5\textwidth}
...
\includegraphics[scale=0.4]{1d3_3.png}\\
\column{0.5\textwidth}
{\bf Igjen skal du kun diskutere hvordan oppgaven kan løses.}
Ikke gå videre før du har et forslag til løsning og repeter hele prosessen for hvordan du nå kan finne hvor stort solpanel du trenger for at en satelitt ved saturn skal få nok solenergi til å drive instrumentene ombord. 
...
\includegraphics[scale=0.4]{1d4_1.png}
\column{0.5\textwidth}
\includegraphics[scale=0.32]{1d4_2.png}\\
...
\includegraphics[scale=0.42]{1d4_3.png}\\
\column{0.5\textwidth}
...
\item Du kommer du igjen til å trenge Stefan-Boltzmanns low, $F=\sigma T^4$ der $\sigma$ er et tall og $T$ er temperaturen til legemet. Stefan-Boltzmanns lov gjelder kun for sorte legemer (forklaring senere), vi skal her anta at Saturn er et sort legeme.
\end{itemize}
\textcolor{red}{Ikke gå videre før du har tenkt godt gjennom hva du kan gjøre.}
...
\end{block}
\hyperlink{sblaw2}{\pagebutton{\small Neste side}}
\end{frame}
...
\nytemaside{romvink}
\hyperlink{sblaw2}{\pagebutton{Neste side!}}
\end{frame}
}
...
Kan du huske hvordan et sort legeme er definert??\hyperlink{sblaw2b}{\pagebutton{\small Trykk her når du har vridd hjernen rundt for å huske!}}
}
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[]  \hypertarget<.>{sblaw2b}{}
\end{itemize}
\vspace*{-0.5cm}
...
{\bf Merk at du ikke skal gjøre utledningen, men tenke detaljert gjennom hvordan du ville gått frem!}. Hvis du er usikker, gå gjerne tilbake og se på definisjonen av Stefan-Boltzmanns lov.
...
\includegraphics[scale=0.42]{angle.png}\\
...
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[]  \hypertarget<.>{solidangle2b}{}
\end{itemize}
\column{0.5\textwidth}
{\small 
Hvis vi utvider enhetssirkel fra 2 til 3 dimensjoner får vi enhetskula:
\includegraphics[scale=0.42]{solidangle.png}\\
...
\vspace*{0.5cm}
\hyperlink{nytema4}{\pagebutton{Jeg trekker pusten nå og er klar til ...}}
\end{frame}
}
...
\]
\centerline{\includegraphics[scale=0.7]{intensity.png}}
...
\]
{\bf\Large ??}\\
\hyperlink{bnuja}{\choicebutton{JA!}}\ \ \ \ \hyperlink{bnunei}{\choicebutton{NEI!}}\
\end{frame}
...
Her ser du $B(\lambda)$:\\
\includegraphics[scale=0.5]{blambda.png}\\
...
Da er du klar til å løse oppgave 1D.1. Diskuter hvordan du vil gå frem for å løse denne oppgaven. Hvis du sliter, kontakt gruppelærer.
\column{0.6\textwidth}
\includegraphics[scale=0.45]{1d1.png}
\end{columns}
...
\vspace*{0.5cm}
\hyperlink{nytema5}{\pagebutton{Gå videre...}}
\end{frame}
}
...
\hyperlink{straling1b}{\pagebutton{Trykk her når du har tenkt}}
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[] \hypertarget<.>{straling1b}{}
\end{itemize}
\vspace{-0.5cm}
\begin{itemize}
...
\end{block}
\hyperlink{nytema6}{\pagebutton{Neste side}}
\end{frame}
...
\includegraphics[scale=0.15]{bremss.png}{\tiny (Figur: Wikipedia)}
...
\includegraphics[scale=0.3]{21cm.png}{\tiny (Figur: Wikipedia)}
