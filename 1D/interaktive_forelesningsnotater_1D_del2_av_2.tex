...
\vspace*{0.5cm}
\hyperlink{linjeintro6_b}{\choicebutton{\small Nei, det absorberer enda på $\lambda_0$}}\ \ \ \ \hyperlink{linjeintro6_b}{\choicebutton{\small Ja, det vil vel nå absorbere på en lengre bølgelengde}}\ \ \ \ \hyperlink{riktig_linjeintro7}{\choicebutton{\small Ja, det vil vel nå absorbere på en kortere bølgelengde}}
\column{0.5\textwidth}
...
Korrekt, for atomet som går i retning mot stjerna vil det virke som at stjerna beveger seg mot atomet. Vil det ha en innvirkning på bølgelengden som elektronet i atomet absorberer?\\
\vspace*{0.5cm}
{\choicebutton{\small Nei, det absorberer enda på $\lambda_0$}}\ \ \ \ {\choicebutton{\small Ja, det vil vel nå absorbere på en lengre bølgelengde}}\ \ \ \ {\choicebutton{\small Ja, det vil vel nå absorbere på en kortere bølgelengde}}
\column{0.5\textwidth}
...
\hyperlink{feilmag}{\choicebutton{\small$F_1=5\log{F_2}$}}\ \ \ \ \hyperlink{feilmag}{\choicebutton{\small$F_1=10^{(\log{F_2})/5}$}}\ \ \ \ \hyperlink{feilmag}{\choicebutton{\small$F_1-F_2=5\log{(m_1-m_2)}$}}\ \ \ \ \hyperlink{riktigmag}{\choicebutton{\small$F_1=F_2100^{(m_2-m_1)/5}$}}\ \ \ \ \hyperlink{feilmag}{\choicebutton{\small$F_1-F_2=10\log{[(m_2-m_1)/5]}$}}\ \ \ \ \hyperlink{riktigmag}{\choicebutton{\small$m_1-m_2=2.5\log{(F_1/F_2)}$}}\ \ \ \ \hyperlink{feilmag}{\choicebutton{\small$m_1=m_2\log{[(F_1-F_2)/5]}$}}\ \ \ \ \hyperlink{feilmag}{\choicebutton{\small$m_1=m_210^{5(F_1-F_2)}$}}\ \ \ \ \hyperlink{feilmag}{\choicebutton{\small$m_1=m_25\log{(F_1-F_2)}$}}\ \ \ \ \hyperlink{feilmag}{\choicebutton{\small$m_1/m_2=100^{(5F_1/F_2)}$}}\ \ \ \ \hyperlink{feilmag}{\choicebutton{\small$F_1/F_2=100^{(5m_1/m`_2)}$}}
}
}
\end{frame}
}
