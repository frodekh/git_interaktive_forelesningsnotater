...
\newcommand{\clastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/165595}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\headlinebutton{\headline}\\}
\newcommand{\dlastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/165595}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\headlinebutton{\headline}\\}
...
\newcommand{\clastpagebuttoncr}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/165595}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\\\headlinebutton{\headline}\\}
\newcommand{\dlastpagebuttoncr}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/165595}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\\\headlinebutton{\headline}\\}
...
\includegraphics[scale=0.4]{ladder1.png}
\column{0.5\textwidth}
{\small
...
{\bf Ble du skremt av antall sider her? Ta det rolig, de fleste av disse sidene er store bilder/figurer, tilsammen med 3B (som er veldig kort) tilsvarer dette 2 forelesninger.}
...
\href{https://nettskjema.no/a/165578}{\choicebutton{Nei}}\ \ \ \ \hyperlink{brainstormdone}{\choicebutton{Ja}}\\
...
\includegraphics[scale=0.3]{fox_middle.png}\hspace*{-11.3cm}{\tiny\textcolor{white}{Bilde fra:https://all-free-download.com/free-photos/download/nz-landscape-from-the-van\_514273.html, author: Benurs}}\\
...
\includegraphics[scale=0.3]{fox_right.png}\hspace*{-11.3cm}{\tiny\textcolor{white}{Små figurer: fra hiclipart.com}}\\
...
\hyperlink{paral3}{\pagebutton{Tenk deg godt om før du blar om!}}
\end{frame}
...
Hvis ikke, prøv å tegne alt ovenfra: begge øynene dine, reven og fjellene. Ser du det nå?
...
\begin{frame}
\label{paral4}
\lastpagebutton{paral3}
\includegraphics[scale=0.3]{fox_middle.png}\\
...
\includegraphics[scale=0.36]{fox_left.png}\\
...
\centerline{\includegraphics[scale=0.2]{fox_middle.png}}
...
\includegraphics[scale=0.3]{fox_eyes.png}\hspace*{-9cm}{\tiny\textcolor{white}{Små figurer: fra hiclipart.com}}\\
Her ser du situasjonen ovenfra. Merk at siden fjellene er veldig langt borte så vil linjene fra hver av øynene til fjellene være nesten paralelle (har du lagt merke til at hvis du kjører bil og har månen rett over deg, så vil månen enda være rett over deg etter at du har kjørt en god stund. Linja fra deg til månen er rett opp i begge tilfeller). {\bf Ser du at fra det ene øyet er reven en vinkel $p$ til venstre for fjellet, fra det andre øyet er reven en vinkel $p$ til høyre?}
...
\includegraphics[scale=0.36]{all_foxes.png}\\
...
\includegraphics[scale=0.19]{all_foxes.png}\includegraphics[scale=0.19]{fox_eyes.png}\\
{\bf Ser du det??} Hvis ikke, spør! Men hva tror du vinkelen $p$ avhenger av? Hvordan kunne du fått denne vinkelen til å bli større eller mindre? Kansje du kan prøve deg frem med tommelen og se om du ser det?
...
\includegraphics[scale=0.36]{fox_eyes_distance.png}\\
...
\includegraphics[scale=0.36]{fox_eyes_distance.png}\\
Er avstanden til reven:\hyperlink{paral13a}{\choicebutton{229m}}\ \ \ \hyperlink{paral13a}{\choicebutton{57m}}\ \ \ \ \hyperlink{paral13a}{\choicebutton{286m}}\ \ \ \ \hyperlink{paral13b}{\choicebutton{115m}}
\end{frame}
...
\centerline{\includegraphics[scale=0.3]{fox_eyes_distance.png}}
...
\hyperlink{paral15}{\pagebutton{\small Jeg har et svar!}}
\end{frame}
...
\begin{frame}
\label{paral15b}
\lastpagebutton{paral15}
\centerline{\includegraphics[scale=0.2]{galaxy_left.png}\ \includegraphics[scale=0.2]{galaxy_right.png}}
...
\centerline{\includegraphics[scale=0.8]{fig_11-2.pdf}}
...
\centerline{\includegraphics[scale=0.3]{galaxy_both.png}}
...
\hyperlink{paral19a}{\choicebutton{ca. 32\,ly}}\ \ \ \hyperlink{paral19b}{\choicebutton{ca. 65\,ly}}\ \ \ \hyperlink{paral19a}{\choicebutton{ca. 130\,ly}}\ \ \ \hyperlink{paral19a}{\choicebutton{ca. 260\,ly}}\ \ \ \hyperlink{paral19a}{\choicebutton{ca. 520\,ly}}\ \ \ 
\end{frame}
...
\hyperlink{paral19d}{\pagebutton{Jeg tror jeg vet det!}}
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[] \hypertarget<.>{paral19d}{}
\end{itemize}
\vspace{-0.5cm}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.4]{ladder2.png}
\hyperlink{paral19b}{\pagebutton{\small Forrige side}}
\column{0.5\textwidth}
...
\begin{frame}
\label{msfit1}
\dlastpagebutton{paral19b}\label{hrfit}
...
Jepp, tida har kommet til å introdusere dere til et av de viktigste redskaper for å studere stjerners liv og virke. Men for å forstå hva et Hertzsprung-Russel-diagram, eller bare {\bf HR-diagram}, er så trenger du å vite hva en sjernehop er, eller rettere sagt hva en åpen hop og en kulehop er.
...
\end{itemize}
\hyperlink{msfit5}{\pagebutton{Neste side}}
\end{frame}
...
\begin{frame}
\label{msfit6}
\lastpagebutton{msfit5}
\centerline{\includegraphics[scale=0.13]{globular_cluster_NGC362.jpg}}
...
\begin{frame}
\label{msfit7}
\lastpagebutton{msfit6}
Siden stjernene i slike hoper er født omtrent samtidig, blir de brukt til å studere stjerners livsløp da du som regel vil finne stjerner med alle mulige forskjellige aldre. Et viktig redskap for å studere en slik hop er {\bf HR-diagrammet}. Her ser du et slikt:
\centerline{\includegraphics[scale=0.4]{fig_11-3.pdf}}
På x-aksen har vi altså sjernas overflatetemperatur, økende mot venstre. På y-aksen har vi stjernas luminositet eller absolutt størrelseklasse. For å lage et slikt diagram for en stjernehop, må du altså finne temperaturen og luminositeten til alle stjernene og plotte de inn her.
...
\centerline{\includegraphics[scale=0.38]{fig_11-3.pdf}}
{\footnotesize
...
\hyperlink{msfit12}{\pagebutton{Neste side}}
\end{frame}
...
\centerline{\includegraphics[scale=0.09]{open_cluster_NGC265.jpg}}
\textcolor{yellow}{Hva nå med vår åpne hop NGC265 som ligger i den Store Magellanske Sky? Den ligger for langt unna til at vi kan måle avstanden med parallakse! Vi kan altså kun måle {\bf tilsyndelatende størrelseklasse} $m$ og {\bf ikke absolutt størrelseklasse} $M$ for stjernene i denne hopen. Overflatetemperaturen kan vi enda måle, da vi kun trenger spektret fra stjernen for å måle den.}
...
\hyperlink{msfit14}{\pagebutton{Tenk det godt om før du blar om!}}
\end{frame}
...
\hyperlink{msfit15}{\pagebutton{Tenk det godt om før du blar om!}}
\end{frame}
}
...
\centerline{\includegraphics[scale=0.38]{fig_11-4a.pdf}\includegraphics[scale=0.38]{fig_11-4b.pdf}}
{\footnotesize
...
\hyperlink{msfit19a}{\choicebutton{8pc}}\ \ \ \hyperlink{msfit19a}{\choicebutton{10pc}}\ \ \ \hyperlink{msfit19a}{\choicebutton{12pc}}\ \ \ \hyperlink{msfit19b}{\choicebutton{25pc}}\ \ \ \hyperlink{msfit19a}{\choicebutton{50pc}}\ \ \ \hyperlink{msfit19a}{\choicebutton{100pc}}\ \ \ 
\end{frame}
...
\hyperlink{msfit21}{\pagebutton{Neste side}}
\end{frame}
...
\begin{frame}
\label{pause}
\hyperlink{msfit21}{\pagebutton{\small Forrige side}}
\begin{columns}
\column{0.5\textwidth}
{\Huge\bf \centerline{\textcolor{yellow}{Kaffe?}}}
\vspace*{-0.9cm}
\centerline{\includegraphics[scale=0.45]{ladder_coffee.png}}
\column{0.5\textwidth}
...
\vspace*{0.5cm}
\hyperlink{nytema3}{\pagebutton{\small Klar for steget ut av vår galakse?}}
\end{columns}
\end{frame}
}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.4]{ladder3.png}
\hyperlink{msfit21}{\pagebutton{\small Forrige side}}
\column{0.5\textwidth}
...
\begin{frame}
\label{di1}
\lastpagebutton{msfit21}\label{cepheider}
{\footnotesize
...
\includegraphics[scale=0.35]{cepheide_kurve.png}\\
...
\]
\hyperlink{di7c}{\choicebutton{$14\mathrm{ly}$}}\ \ \ \ \hyperlink{di7c}{\choicebutton{$26\mathrm{ly}$}}\ \ \ \ \hyperlink{di7c}{\choicebutton{$84\mathrm{ly}$}}\ \ \ \ \hyperlink{di7d}{\choicebutton{$200\mathrm{ly}$}}\ \ \ \ \hyperlink{di7c}{\choicebutton{$319\mathrm{ly}$}}
\end{frame}
...
\end{itemize}
Siden denne kritiske massegrensen alltid er den samme, så vil luminositeten, energien som frigjøres i eksplisjonen, også alltid være omtrent den samme. Supernovaer av type Ia er derfor meget gode {\bf standardlyskilder}.
\hyperlink{di10}{\pagebutton{Neste side}}
\end{frame}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.1]{SNIa.jpg}
...
\hyperlink{di11}{\pagebutton{Neste side}}\\
...
} \hyperlink{nytema4}{\pagebutton{Neste side}}
\end{columns}
\end{frame}
}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.4]{ladder4.png}
\hyperlink{di11}{\pagebutton{\small Forrige side}}
\column{0.5\textwidth}
...
\label{tf2}
\lastpagebutton{tf1}
{\Huge På de neste sidene skal du få gjøre litt detektivarbeid. Du skal se rett og slett se hvor mange tips du trenger før du innser hvorfor det er en relasjon mellom bredden av 21cm-linja og luminositeten til galaksen.}
\textcolor{red}{Første forsøk kommer nå: klarer du å se hvorfor det er en slik sammenheng uten noe tips? Tegn galaksen med hydrogenskyene i bane, det kan være til hjelp.}
...
Emisjonslinjen på 21cm fra en galakse har en meget spesiell form. Ta en kikk på \href{https://www.uio.no/studier/emner/matnat/astro/AST2000/h20/undervisningsmateriell/interaktive-forelesningsnotater/3a/videoer/video3a_3.mp4}{denne videoen} for å se formen på linja. Kan du tenke deg hvorfor linja har denne formen? Og hjelper det deg til å forstå hvorfor vi har en relasjon mellom bredden av 21cm-linja og luminositeten til galaksen?
\end{alertblock}
...
I \href{https://www.uio.no/studier/emner/matnat/astro/AST2000/h20/undervisningsmateriell/interaktive-forelesningsnotater/3a/videoer/video3a_5.mp4}{denne videoen} får du se hvorfor vi har to topper. Vi vet altså at rotasjonskurven til galaksen flater ut og at alle hydrogenskyer i de ytre delene av galaksen har omtrent samme banehastighet og dermed omtrengt samme Dopplereffekt. Men hva avjør hvor langt $\Delta\lambda$ fra sentrum av linja denne toppen befinner seg? Ser du nå opphavet til relasjonen?
\end{alertblock}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.4]{ladder5.png}
