...
\newcommand{\clastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/167466}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\headlinebutton{\headline}\padletbutton\\}
\newcommand{\dlastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/167466}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\headlinebutton{\headline}\padletbutton\\}
...
\newcommand{\clastpagebuttoncr}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/167466}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\\\headlinebutton{\headline}\padletbutton\\}
\newcommand{\dlastpagebuttoncr}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/167466}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\\\headlinebutton{\headline}\padletbutton\\}
...
\includegraphics[scale=0.6]{NASA-Sun.jpg}
\column{0.5\textwidth}
{\small
\textcolor{yellow}{\bf Velkommen til del 3C! I denne delen av kurset skal du lære å regne på kjernereaksjoner. Du skal finne ut hvordan vi, basert på temperatur, tetthet og sammensetningen av kjernen til en stjerne kan beregne dens luminositet.}\\
...
\href{https://nettskjema.no/a/167463}{\choicebutton{Nei}}\ \ \ \ \hyperlink{brainstormdone}{\choicebutton{Ja}}\\
...
\hyperlink{mass2f}{\choicebutton{Ja, selvsagt, den kjøper jeg!}}\\
\hyperlink{mass2r}{\choicebutton{Nei, jeg tror ikke det kan stemme!}}\\
\end{frame}
...
\begin{frame}
\label{mass4}
\lastpagebutton{mass3}
La oss putte noen atomkjerner på kjøkkenvekta vår:
\includegraphics[scale=0.4]{atom_scale1.png}\\
...
\begin{frame}
\label{mass6}
\lastpagebutton{mass5}
{\bf\Large OG svaret er:}
\includegraphics[scale=0.4]{atom_scale2.png}\\
...
\begin{frame}
\label{mass9}
\lastpagebutton{mass8}
\includegraphics[scale=0.6]{fig_19-3.pdf}\\
Figuren viser en skisse av grafen for nukleontall (antall nukleoner i en atomkjerne) på x-aksen og masse per nukleon på y-akse. {\bf Vi ser at masse per nukleon faller kraftig fra Hydrogen og til tyngre grunnstoffer. Men kun frem til jern (Fe). Deretter øker massen per nukleon igjen til de tyngde grunnstoffene.} \textcolor{red}{Vi vil altså vinne energi hvis vi går fra høy til lav masse per nukleon! Altså hvis vi fusjonerer en lett atmokjerne, eller fisjonerer en tung atomskjerne.}
\hyperlink{mass10}{\pagebutton{Neste side}}
\end{frame}

\begin{frame}
\label{mass10}
\lastpagebutton{mass9}
\includegraphics[scale=0.6]{fig_19-3.pdf}\\
...
\begin{frame}
\label{fusj1}
\lastpagebutton{mass10}\label{fusjon}
\includegraphics[scale=0.6]{approaching_protons.png}\\
...
\hyperlink{fusj9f}{\choicebutton{$\frac{d\epsilon(r)}{dr}=\frac{\rho(r)L(r)}{4\pi r^2}$}}\ \ \ \hyperlink{fusj9f}{\choicebutton{$\frac{d\epsilon(r)}{dr}=\frac{4\pi r^2L(r)}{\rho(r)}$}}\hyperlink{fusj9f}{\choicebutton{$\frac{dL(r)}{dr}=\frac{\rho(r)\epsilon(r)}{4\pi r^2}$}}\ \ \ \hyperlink{fusj9f}{\choicebutton{$\frac{dL(r)}{dr}=\frac{4\pi r^2\epsilon(r)}{\rho(r)}$}}\ \ \ \hyperlink{fusj9r}{\choicebutton{$\frac{dL(r)}{dr}=4\pi r^2\rho(r)\epsilon(r)$}}
\end{frame}
...
\vspace*{0.5cm}
\hyperlink{nytema3}{\pagebutton{La oss regne litt på fusjonsreaksjoner!}}
\end{frame}
}
...
\begin{frame}
\label{reak1}
\lastpagebutton{fusj9r}\label{reaksjoner}{%\small
...
\column{0.3\textwidth}
\includegraphics[scale=0.1]{pp_chain_Wiki.pdf}
\end{columns}
...
\column{0.4\textwidth}
\includegraphics[scale=0.12]{CNO_cycle_Wiki.pdf}
\end{columns}
Og med 
\[
...
\hyperlink{reak6f}{\choicebutton{til det dobbelte}}\ \ \hyperlink{reak6f}{\choicebutton{til det firedobbelte}}\ \ \hyperlink{reak6f}{\choicebutton{5 ganger}}\ \ \hyperlink{reak6r}{\choicebutton{7 ganger}}\ \ \hyperlink{reak6f}{\choicebutton{10 ganger}}\ \   
\end{frame}
...
{\small (Illustrasjon: Wikipedia)}
\column{0.4\textwidth}
\includegraphics[scale=0.12]{triple-alpha_Wiki.pdf}
\end{columns}
Og med 
\[
...
\hyperlink{reak8f}{\choicebutton{til det dobbelte}}\ \ \hyperlink{reak8f}{\choicebutton{10 ganger}}\ \ \hyperlink{reak8f}{\choicebutton{100 ganger}}\ \ \hyperlink{reak8f}{\choicebutton{1000 ganger}}\ \ \hyperlink{reak8r}{\choicebutton{mer enn 1000 ganger}}\ \   
\end{frame}
...
\begin{frame}
\label{snp1}
\lastpagebutton{reak10}\label{snp}
{\Large
