...
\begin{frame}
\label{front}
\center{\Large \textcolor{darkscarlet}{\bf AST2000 Del 2C forlesning 2 av 2\\Interaktive forelesningsnotater}}\\
\vspace*{1cm}
...
\href{https://nettskjema.no/a/172649}{\choicebutton{Nei}}\ \ \ \ \hyperlink{brainstormdone}{\choicebutton{Ja}}\\
...
\nytemaside{ff}
\textcolor{yellow}{\Large Normalt kommer jeg bare frem til ca. side \ref{gps} i den fysiske forelesningen og tar resten uka etter. Det anbefaler jeg at du også gjør! Vi skal nå snakke om maksimal aldring og ta en liten pause midtveis før neste tema.}
...
\centerline{\includegraphics[scale=0.22]{maks_aldring2.png}}
...
\centerline{\includegraphics[scale=0.22]{maks_aldring1.png}}
...
\centerline{\includegraphics[scale=0.3]{maks_aldring1.png}}
Bare et av disse utsagnene er riktig, trykk på det riktige:
\hyperlink{ma5a}{\choicebutton{rød sakker farten, grønn øker farten}}\\
\hyperlink{ma5a}{\choicebutton{grønn sakker farten, blå øker farten}}\\
\hyperlink{ma5b}{\choicebutton{grønn sakker farten, rød øker farten}}\\
\hyperlink{ma5a}{\choicebutton{blå sakker farten, rød øker farten}}
}

\colchoiceframe{ma5a}{ma5}{0}{black}{
\centerline{\includegraphics[scale=0.3]{maks_aldring1.png}}
\textcolor{yellow}{
...
\colfullframe{ma5b}{ma5}{ma6}{-1}{yellow}{\Large
\centerline{\includegraphics[scale=0.22]{maks_aldring1.png}}
...
\fullframe{ma8}{ma7}{ma9}{0}{
\centerline{\includegraphics[scale=0.3]{maks_aldring1.png}}
Fikk du...\pagequestion{ma8b}{Ja, jeg fikk...}{-1}
\[
...
\fullframe{ma11}{ma10}{ma12}{0}{\small
\centerline{\includegraphics[scale=0.3]{maks_aldring1.png}}
Fikk du...\pagequestion{ma11b}{\small Ja, jeg fikk...}{-1}
\[
...
\colfullframe{ma16}{ma15}{ma17}{0}{red}{
\textcolor{yellow}{
...
\centerline{\includegraphics[scale=0.22]{maks_aldring3.png}}
...
\centerline{\includegraphics[scale=0.2]{maks_aldring3.png}}
...
\\
\vspace*{0.5cm}
\hyperlink{ma21}{\pagebutton{Jeg er klar til å fortsette...}}
\end{frame}
}

\colfullframe{ma21}{ma20}{ma21x}{0}{denim}{\footnotesize
\centerline{\includegraphics[scale=0.24]{maks_aldring4.png}}
\textcolor{yellow}{
...
\colfullframe{ma21x}{ma21}{ma22}{0}{red}{\large
\textcolor{yellow}{
...
\fullframe{ma22}{ma21x}{ma23}{0}{\small
\centerline{\includegraphics[scale=0.2]{maks_aldring5.png}}
Her ser vi igjen 3 mulige verdenslinjer, eller retter sagt det bittelille utsnittet av mulige verdenslinjer til ballen mellom høyde $r_1$ til $r_3$ fra tidspunkt $t_1$ til $t_3$ der det har konstant hastighet (rett linje) fra $r_1$ til $r_2$ og en (mulig) annen konstant hastighet fra $r_2$ til $r_3$. Her beveger ballen seg over flere skall så vi kan ikke anta lokalt inertialsystem for hele reisen. Dermed må vi bruke \ss-geometri. Kan du sette opp et uttrykk for den totale egentida slik som du gjorde tidligere? Ikke bla om før du har et forslag.
}

\fullframetwo{ma23}{ma22}{ma24}{0}{
\centerline{\includegraphics[scale=0.22]{maks_aldring5.png}}}
{\footnotesize
Fikk du:
\begin{align*}
...
\centerline{\includegraphics[scale=0.21]{maks_aldring5.png}}
\footnotesize
...
\hyperlink{ff1}{\pagebutton{La oss kaste oss ut mot det sorte hullet!}}
\end{frame}
}



\colchoiceframe{ff1}{ma28}{0}{denim}{\label{ff}\small
...
Vi er tilbake til den {\bf fritt fallende observatøren}. Hun begynner å falle {\bf radialt innover} mot det sorte hullet fra en veldig stor avstand $r\rightarrow\infty$ og med null hastighet $v=0$. Etterhvert vil gravitasjonen fra det sorte hullet akselerere henne innover mot hullet. La oss prøve å finne et uttrykk for hastigheten hennes som funksjon av tida. {\bf Aller først:} Hva er totalenergien $E$ som hun starter med?\\
 \hyperlink{ff1a}{\choicebutton{$E=0$}}\hyperlink{ff1a}{\choicebutton{$E=1$}}\hyperlink{ff1b}{\choicebutton{$E=m$}}\hyperlink{ff1a}{\choicebutton{$E=m\gamma$}}\hyperlink{ff1a}{\choicebutton{$E=mM$}}
}
}

\colchoiceframe{ff1a}{ff1}{0}{black}{\Huge
\textcolor{yellow}{
...
\colfullframe{ff1b}{ff1}{ff2}{-1}{yellow}{\Huge
Det ble riktig. Vi begynner med energi $E=m$ i grensen $r\rightarrow\infty$ og $v=0$.
}

\fullframetwo{ff2}{ff1b}{ff3}{0}{\footnotesize
...
{
\centerline{\includegraphics[scale=0.32]{2c4.png}}
}
...
\textcolor{red}{Du kan få bruk for formlene til høyre for å svare på disse spørsmålene:}
\begin{itemize}
...
\nytemaside{0}
\textcolor{yellow}{\Large I den fysiske forelesningen rekker jeg normalt såvidt å begynne på dette temaet, kanskje 5-6 sider til. Hvis du er litt sliten nå, bør du også vente med resten til neste uke. Er du derimot frisk og opplagt er det ingenting i veien for å fortsette {\bf etter en skikkelig pause}.}
\hyperlink{gps1}{\pagebutton{Hva har relativitetsteorien å gjøre med posisjonsmålinger?}}
\end{frame}
}

\fullframe{gps1}{ff7b}{gps2}{0}{\label{gps}
\centerline{\includegraphics[scale=0.32]{gps.png}}
...
\fullframe{gps2}{gps1}{gps3}{0}{\Large
\centerline{\includegraphics[scale=0.32]{gps.png}}
...
\colfullframetxt{gps3}{gps2}{gps4}{0}{red}{Nå har jeg det!}{\Large
\centerline{\includegraphics[scale=0.32]{gps.png}}
\textcolor{yellow}{
{\Large Fikk du det til???} Trenger du et hint?}
\hyperlink{gps4}{\pagebutton{Neida, fikk det til jeg!}}\pagequestion{gps3b}{Gjerne et hint ja!}{-1}
...
\fullframe{gps4}{gps3}{gps5}{1}{\Large
\centerline{\includegraphics[scale=0.7]{gps2.png}}
...
\hyperlink{gps5a}{\choicebutton{$\Delta x\approx 3$ meter}}\hyperlink{gps5a}{\choicebutton{$\Delta x\approx 30$ meter}}\\
\hyperlink{gps5b}{\choicebutton{$\Delta x\approx 300$ meter}}\hyperlink{gps5a}{\choicebutton{$\Delta x\approx 3$ kilometer}}
}


\colchoiceframe{gps5a}{gps5}{0}{black}{\Huge
\textcolor{yellow}{
Her var du litt rask, prøv igjen, dette får du til! 
}
}

\colfullframetxt{gps5b}{gps5}{gps6}{-1}{yellow}{mener du et relativistisk problem? Ja, saktens...}{\Huge
...
\fullframetxt{gps6}{gps5b}{gps7}{0}{Tror jeg husker...}{\Large
...
\fullframe{gps7}{gps6}{gps8}{0}{\small
...
\fullframe{gps9}{gps8}{gps10}{0}{\large
...
\colfullframetxt{gps10}{gps9}{gps11}{0}{red}{Jeg har tenkt og tenkt...}{\Huge
\textcolor{yellow}{
Her bør du prøve å se om du finner en løsning. Dette kan være en typisk oppgave...\pagequestion{gps10b}{Hint? Please?}{-1}
Det fikk du på forrige side, selv om det ikke står eksplisitt at det er et hint...
}
}

\fullframetxt{gps11}{gps10}{gps12}{1}{Absolutt, dette kan jeg!}{
...
\fullframe{gps12}{gps11}{gps13}{0}{
La oss begynne med $\Delta\tau_\mathrm{sat}$, kan du finne et uttrykk for denne som også inneholder $\Delta t$?\pagequestion{gps12b}{Hint?}{-1}
Et egettidsintervall mellom to eventer er vel lik tidromsintervallet mellom disse eventene? Og hvordan ser tidromsintervallet ut?\pagequestion{gps12c}{Ahaa.....}{0}
...
\]
der $\Delta s$ og $\Delta t$ altså er tidroms- og langt-vekktidsintervall mellom de to tikkene på satelittklokka.\pagequestion{gps12d}{OK!}{0}
...
\fullframe{gps13}{gps12}{gps14}{1}{
Vi hadde altså
\[
\Delta\tau_\mathrm{sat}^2=\left(1-\frac{2M}{r_\mathrm{sat}}\right)\Delta t^2-r_\mathrm{sat}^2\Delta\phi_\mathrm{sat}^2
\]
Men vi har en $\Delta\phi_\mathrm{sat}$ her! Hadde det ikke vært bedre å få inn satelitthastigheten $v_{\phi,\mathrm{sat}}$? Hvordan kan du gjøre det?\pagequestion{gps13b}{Jeg har tenkt og har et forslag...}{-2}
...
Vi kan bruke nøyaktig samme tankegang for oss selv som skallobservatører og komme frem til nøyakti samme uttrykk:
\[
...
\fullframe{gps19}{gps18}{gps20}{0}{\large
\[
\frac{\Delta\tau_\mathrm{jord}}{\Delta\tau_\mathrm{sat}}=\sqrt{\frac{1-\frac{2M}{r_\mathrm{jord}}-v_{\phi,\mathrm{jord}}^2}{1-\frac{2M}{r_\mathrm{sat}}-v_{\phi,\mathrm{sat}}^2}}
\]
Jaaaa, altså hvis $2M/r$ og $v^2$ er små størrelser, hvorfor ikke {\bf rekkeutvikle} i disse? Da skulle vi ende opp med polynomer som vi fint kan regne uten numeriske problemer. {\bf Dette pleier å være løsningen!}. Men hvordan vil du gå frem for å rekkeutvikle her?\pagequestion{gps19b}{Tjaaaaaa...}{-1}
