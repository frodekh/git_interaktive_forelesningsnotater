...
\newcommand{\clastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/160341}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\headlinebutton{\headline}\\}
\newcommand{\dlastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/160341}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\headlinebutton{\headline}\\}
...
\newcommand{\clastpagebuttoncr}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/160341}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\\\headlinebutton{\headline}\\}
\newcommand{\dlastpagebuttoncr}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/160341}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\\\headlinebutton{\headline}\\}
...
%\vspace{1cm}
\includegraphics[scale=0.5]{dark_matter.jpg}\\
\column{0.5\textwidth}
...
\href{https://nettskjema.no/a/160496}{\choicebutton{Nei}}\ \ \ \ \hyperlink{brainstormdone}{\choicebutton{Ja}}\\
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.2]{std_model_Wiki.pdf}\\
...
\begin{frame}
\label{partikler2}
\lastpagebutton{partikler1}
Kun et av disse utsagnene er riktig, trykk på det rikige!\\
\hyperlink{f1}{\choicebutton{protoner er bosoner}}\\
\hyperlink{f1}{\choicebutton{fotoner er fermioner}}\\
\hyperlink{f1}{\choicebutton{Higgspartikkelen er et fermion}}\\
\hyperlink{f1}{\choicebutton{nøytronet er et boson}}\\
\hyperlink{r1}{\choicebutton{nøytrinoet er et fermion}}\\
\hyperlink{f1}{\choicebutton{gravitonet er et fermion}}\\
\end{frame}
...
\begin{frame}
\label{r1}
\clastpagebutton{partikler2}
{\Huge\bf Flott, bra jobba!}
...
\lastpagebutton{partikler2}
Kun et av disse utsagnene er riktig, trykk på det rikige!\\
\hyperlink{f2}{\choicebutton{nøytroner er mesoner}}\\
\hyperlink{f2}{\choicebutton{protoner er leptoner}}\\
\hyperlink{f2}{\choicebutton{nøytrinoer er hadroner}}\\
\hyperlink{f2}{\choicebutton{kvarker er baryoner}}\\
\hyperlink{f2}{\choicebutton{protoner er mesoner}}\\
\hyperlink{r2}{\choicebutton{nøytroner er hadroner}}\\
\end{frame}
...
\lastpagebutton{partikler3}
Kun et av disse utsagnene er riktig, trykk på det rikige!\\
\hyperlink{f3}{\choicebutton{protoner har leptonnummer +1}}\\
\hyperlink{f3}{\choicebutton{elektronnøytrinoet har elektrisk ladning -1}}\\
\hyperlink{f3}{\choicebutton{oppkvarken har elektrisk ladning +1}}\\
\hyperlink{f3}{\choicebutton{nedkvarken har leptonnumer +1}}\\
\hyperlink{r3}{\choicebutton{fotoner kan ha spinn +1}}\\
\hyperlink{f3}{\choicebutton{positronet(antipartikkelen til elektronet) har el. ladning -1}}\\
\end{frame}
...
\begin{frame}
\label{partikler6}
\lastpagebutton{partikler5}
 {\Huge\bf Fikk du det riktig?} Hvis ikke, ta en runde til med repetisjon om elementærpartikler så det sitter skikkelig!
...
\nytemaside{morkmat}
\hyperlink{rotkurv0}{\pagebutton{Sett igang!}}
\end{frame}
}
...
\begin{frame}
\label{rotkurv0}
\lastpagebutton{partikler6}\label{rotakurv}
\textcolor{yellow}{
{\small
...
\includegraphics[scale=0.45]{fig_4-1.pdf}\\
...
\begin{frame}
\label{rotkurv1}
\lastpagebutton{rotkurv0}
\begin{columns}
\column{0.5\textwidth}
Tilbake til spørsmålet på skjemaet. Under ser du en galakse: 
\includegraphics[scale=0.15]{dark_matter.jpg}\\
...
\hyperlink{rotkurv1b}{\pagebutton{Trykk her når du har forslag!}}
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[]  \hypertarget<.>{rotkurv1b}{}
\end{itemize}
\vspace*{-1cm}
...
\hyperlink{rotkurv3b}{\pagebutton{Trykk her når du har forslag!}}
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[]  \hypertarget<.>{rotkurv3b}{}
\end{itemize}
\vspace*{-1cm}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.45]{fig_4-2.pdf}\\
\column{0.5\textwidth}
...
\hyperlink{rotkurv5}{\pagebutton{Neste side}}
\end{columns}
\end{frame}
...
\begin{frame}
\label{rotkurv5}
\lastpagebutton{rotkurv4}
\textcolor{yellow}{\Huge Hva kan forårsake et så stort avvik mellom teori og observasjon?}
...
\hyperlink{rotkurv6b}{\pagebutton{Neste side}}
\end{frame}
...
\begin{frame}
\label{rotkurv7}
\lastpagebutton{rotkurv6}
\textcolor{red}{\Huge Det er her hypotesen om \textcolor{black}{\bf mørk materie} kommer inn. For at $M(r)$ skal kunne øke nevneverdig med $r$ i de ytre delene av galaksen, sa må det finnes materie der som ikke er synlig, som ikke avgir lys, derav \textcolor{black}{\bf mørk materie}}
...
\begin{frame}
\label{pause}
\hyperlink{rotkurv7}{\pagebutton{\small Forrige side}}
{\Huge
\centerline{Kaffe???  Yes!!}
\centerline{\includegraphics[scale=4]{drink-coffee.png}}\\
Dette var mørkt stoff, og mørkere skal det bli! Dermed trenger du en tur ut i dagslys nå!!
\vspace*{0.5cm}
Ihvertfall 10 min...
}\\
\vspace*{0.5cm}
\hyperlink{nytema3}{\pagebutton{Har klarnet tankene nå!}}
\end{frame}
}
...
\begin{frame}
\label{mm1}
\lastpagebutton{mm0}\label{morkmat}
\begin{columns}
\column{0.5\textwidth}
Vi begynner med å kikke på en av ukeoppgavene:
\includegraphics[width=\linewidth]{oppgave1f1_1.png}\\
\column{0.5\textwidth}
Finner du massen til galaksene? Kikk deretter på deloppgave 2:
\includegraphics[width=0.97\linewidth]{oppgave1f1_2.png}\\
...
\hyperlink{mm3}{\pagebutton{Neste side}}
\end{frame}
...
\begin{frame}
\label{mm3}
\textcolor{yellow}{\tiny Bilde:NASA/ESA/J. Lotz (STScI)}\lastpagebutton{mm2}
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.75]{lenses.jpg}
\column{0.5\textwidth}
...
\hyperlink{mm4}{\pagebutton{Neste side}}
\end{columns}
\end{frame}
}
...
\textcolor{yellow}{\Huge Men hva er nå denne mørke materien???}\\
...
\hyperlink{mm5}{\pagebutton{Neste side}}
\end{frame}
}
...
\begin{frame}
\label{mm5}
\textcolor{yellow}{\tiny Bilde: ESA/Planck}\lastpagebutton{mm4}
\includegraphics[scale=0.15]{cmb.jpg}
\vspace*{-6cm}
\begin{itemize}
...
\hyperlink{mm7}{\pagebutton{Neste side}}
\end{frame}
}
...
\hyperlink{mm8}{\pagebutton{... neste side}}
\end{frame}
}
...
\label{mm8}
\lastpagebutton{mm7}
\includegraphics[scale=0.25]{dark_matter.jpg}
\textcolor{yellow}{
...
\hyperlink{mm9}{\pagebutton{... neste side}}
\end{frame}
}
...
\hyperlink{nytema4}{\pagebutton{Det skal vi se litt på nå...}}
\end{frame}
}
...
\begin{frame}
\label{nytema4}
\hyperlink{mm9}{\pagebutton{\small Forrige side}}
\nytemaside{hvaer}
...
\begin{frame}
\label{mod1}
\lastpagebutton{mm9}\label{modmat}
...
\begin{frame}
\label{hvamm1}
\lastpagebutton{mod7}\label{hvaer}
\centerline{\Huge\bf Ingen vet!!!}
...
\hyperlink{hvamm3b}{\pagebutton{MEN...}}
\end{frame}
...
\begin{frame}
\label{hvamm3b}
\lastpagebutton{hvamm3}
\textcolor{yellow}{\Huge kanskje det finnes en annen mulighet???}\\
...
\begin{frame}
\label{hvamm4}
\lastpagebutton{hvamm3b}
{\Huge Så flott at du har et forslag! Det vil jeg gjerne høre om...}
\hyperlink{hvamm5}{\pagebutton{Jo, nå skal du høre...}}
\end{frame}

\begin{frame}
\label{hvamm5}
\lastpagebutton{hvamm4}
...
\begin{frame}
\label{hvamm7}
\lastpagebutton{hvamm6}
{\Huge Der står forskningen! \textcolor{red}{Mørk materie? (de fleste forskere heller nok til denne teorien)}\textcolor{blue}{eller modifisert gravitasjon?}Eller noe annet?}
