...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.2]{media/std_model_Wiki.pdf}\\
...
\includegraphics[scale=0.45]{media/fig_4-1.pdf}\\
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.45]{media/fig_4-2.pdf}\\
\column{0.5\textwidth}
...
\begin{frame}
\label{mm0}
\lastpagebutton{riktig_rotkurv7}
...
\begin{frame}
\label{feil_mm5}
\textcolor{yellow}{\tiny Bilde: ESA/Planck}\lastpagebutton{feil_mm4}
...
\begin{frame}
\label{mod1}
\lastpagebutton{feil_mm9}\label{modmat}
