...
\newcommand{\longref}[9]{\href{#1}{#2} \href{#1}{#3} \href{#1}{#4} \href{#1}{#5} \href{#1}{#6} \href{#1}{#7} \href{#1}{#8} \href{#1}{#9}}
...
\newcommand{\clastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/158672}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\headlinebutton{\headline}\\}
\newcommand{\dlastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/158672}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\headlinebutton{\headline}\\}
...
\href{https://nettskjema.no/a/155530}{\choicebutton{Nei}}\ \ \ \ \hyperlink{brainstormdone}{\choicebutton{Ja}}\\
%\hyperlink{intro2}{\choicebutton{Nei}}\ \ \ \ \hyperlink{brainstormdone}{\choicebutton{Ja}}\\
\pause
\addtocounter{pageno}{-1}
\vspace*{1cm}
\begin{itemize}[<+->]
\item[] \hyperlink{basicfysikk1a}{\pagebutton{Neste side}} \hypertarget<.>{brainstormdone}{}
\end{itemize}
...
\includegraphics[scale=0.2]{car_move_1.png}\\
...
La oss begynne med beina godt plantet på jorda. Og med litt {\bf veldig} grunnleggende videregåendeskole-fysikk (sorry!).
\includegraphics[scale=0.2]{car_move_2.png}\\
I figuren ser du en bil som beveger seg med konstant hastighet $v$. Hvilken avstand $\Delta x$ har denne bilen beveget seg i løpet av tiden $\Delta t$?\\
...
\includegraphics[scale=0.3]{spaceship_move_1.png}\\
\column{0.5\textwidth}
\vspace*{0.5cm}\\
...
Nå har vi samme situasjon en gang til, men med vektorer. En romskip har posisjonsvektor $\vec{r}$. Vi skal i resten av dette emnet bruke konseptet {\it posisjonsvektor} ganske mye.
\includegraphics[scale=0.3]{spaceship_move_2.png}\\
\column{0.5\textwidth}
\vspace*{0.5cm}\\
\begin{alertblock}{\bf En posisjonsvektor...}
... er en vektor som peker fra origo i koordinatsystemet ditt til den posisjonen der objektet du studerer er. Når objektet endrer posisjon så endrer også posisjonsvektoren seg tilsvarende slik at den alltid peker på objektets posisjon.
...
\includegraphics[scale=0.2]{spaceship_move_2.png}\\
...
\hyperlink{euler4}{\pagebutton{Neste side}}
\end{frame}
...
{\bf Er du klar?}
\hyperlink{klar}{\choicebutton{{\bf Ja, kom igjen!}}}\ \ \ \ \hyperlink{pyse}{\choicebutton{Tjjjaaaaa....}}\
\end{frame}
...
\includegraphics[scale=0.3]{unity_vectors.png}\\
\column{0.5\textwidth}
...
\]
Hva er $a$ og $b$ her?\\
\hyperlink{feilxy}{\choicebutton{{$a=1\ b=1$}}}\ \ \hyperlink{rettxy}{\choicebutton{$a=3\ b=2$}}\ \ \hyperlink{feilxy}{\choicebutton{$a=2\ b=3$}}\ \ \hyperlink{feilxy}{\choicebutton{$a=0\ b=0$}}
\end{columns}
\end{frame}
...
\includegraphics[scale=0.26]{unity_vectors.png}\\
...
\lastpagebutton{rettxy}
Et lite hint før du får svaret: Hva skjer med enhetsvektorene dersom romskipet beveger seg? Er det en grunnleggende forskjell mellom x-y-enhetsvektorene og r-$\theta$-enhetsvektorene da? \textcolor{red}{Tenk deg om og ...} \hyperlink{xyready}{\choicebutton{trykk her}}\\
\pause
\addtocounter{pageno}{-1}
\vspace*{1cm}
\begin{itemize}[<+->]
\item[] Ganske riktig! r-$\theta$-enhetsvektorene endrer seg med tiden når objektet de peker på endrer posisjon! De er tidsavhengige enhetsvektorer, mens x-y-enhetsvektorene ikke endrer seg. \hypertarget<.>{xyready}{}
\end{itemize}
...
\dlastpagebutton{enhetsvektorer2}
Vi skal se på fordelene etterhvert, men la oss prøve å bruke dem:
\includegraphics[scale=0.28]{unity_vectors.png}\\
Hvis vi nå skal skrive poisjonsvektoren $\vec{r}$ uttrykt ved de nye enhetsvektorne:
\[
\vec{r} = a\vec{e}_r+b\vec{e}_\theta
\]
hva blir da $a$ og $b$?
\hyperlink{feilrt}{\choicebutton{{$a=1\ b=1$}}}\ \ \hyperlink{feilrt}{\choicebutton{$a=3\ b=2$}}\ \ \hyperlink{feilrt}{\choicebutton{$a=\sqrt{13}\ b=\sqrt{13}$}}\ \ \hyperlink{rettrt}{\choicebutton{$a=\sqrt{13}\ b=0$}}\ \ \hyperlink{feilrt}{\choicebutton{$a=0\ b=\sqrt{13}$}}\ \ \hyperlink{feilrt}{\choicebutton{$a=\sqrt{13}\ b=30$}}\ \ \hyperlink{feilrt}{\choicebutton{$a=\sqrt{13}\ b=1$}}
\end{frame}
...
\hyperlink{hastighet1}{\pagebutton{Neste side}}
\end{frame}
}
...
Har du tenkt nøye gjennom hvordan du kunne tenke deg å gjøre det? Har du en ide?\\
\hyperlink{nohintv}{\choicebutton{{Ja, jeg tror det!}}}\\
\hyperlink{hintv}{\choicebutton{tjaaaaa, et bittelite hint kanskje?}}
\end{frame}
...
\begin{frame}
\label{nohintv}
\clastpagebutton{hastighet1}
Var det noe alla:
\[
\vec{v}=\frac{d\vec{r}}{dt}
\]
du tenkte på?\\
 Hvordan går du videre her?\\
\hyperlink{nohintv2}{\choicebutton{Har du en ide?}}\\
\pause
\begin{itemize}[<+->]
\item[] Jepp, kjerneregel selvfølgelig. Da blir det vel: \hypertarget<.>{nohintv2}{}
\end{itemize}
\[
...
\end{block}
\hyperlink{hastighet3}{\pagebutton{Jeg har grublet og er klar til å gå videre}}
\end{frame}
...
\includegraphics[scale=0.5]{unity_vector_decomp.png}\\
...
\hyperlink{eralt}{\choicebutton{... trykker her for noen alternativer}}\\
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[] Er det: \hypertarget<.>{eralt}{}
\end{itemize}
\hyperlink{erfeil}{\choicebutton{$a=\theta\  b = 0$}}\ \ \ \ \hyperlink{erfeil}{\choicebutton{$a=\sin{\theta}\  b = 0$}}\ \ \ \ \hyperlink{erfeil}{\choicebutton{$a=\cos{\theta}\ b=0$}}\ \ \ \ \hyperlink{erfeil}{\choicebutton{$a=\sin{\theta}\  b = \cos{\theta}$}}\ \ \ \ \hyperlink{errett}{\choicebutton{$a=\cos{\theta}\ b=\sin{\theta}$}}\ \ \ \ \hyperlink{erfeil}{\choicebutton{$a=1\ b=\sin{\theta}$}}
\end{frame}
...
\]
(hvordan kan du sjekk
`e om disse er ortogonale?)\\
Nå har du fått god hjelp til å derivere $\vec{e}_r$ med hensyn på tiden. Gjør regningen på papir og se om du finner et av følgende svar:\\
\hyperlink{derfeil}{\choicebutton{$\dot{\vec{e}}_r = \vec{e}_\theta$}}\ \ \ \ \hyperlink{derfeil}{\choicebutton{$\dot{\vec{e}}_r=\cos{\theta}\vec{e}_r$}}\ \ \ \ \hyperlink{derfeil}{\choicebutton{$\dot{\vec{e}}_r=-\sin{\theta}\vec{e}_\theta$}}\ \ \ \ \hyperlink{derrett}{\choicebutton{$\dot{\vec{e}}_r=\dot\theta\vec{e}_\theta$}}\ \ \ \ \hyperlink{derfeil}{\choicebutton{$\dot{\vec{e}}_r=\dot\theta\vec{e}_r+\theta\vec{e}_r$}}\ \ \ \ \hyperlink{derfeil}{\choicebutton{$\dot{\vec{e}}_r=\dot\theta\sin{\theta}\vec{e}_r$}}
\end{frame}
}
...
\]
Hvis du ikke får dette til \textcolor{red}{etter å ha prøvd flere ganger}, ta en titt på \href{https://www.uio.no/studier/emner/matnat/astro/AST2000/h20/undervisningsressurser/interaktive-forelesningsnotater/1b/videoer/video1b_1.mp4}{denne videoen her.}\\
\hyperlink{hastighet4}{\pagebutton{Neste side}}
\end{frame}
}

\begin{frame}
\label{hastighet4}
\lastpagebutton{derrett}
...
La oss se om vi kan utlede uttrykket for tangensiell hastighet, altså $v_\theta = r\dot\theta$ med litt geometri og rent fysiske argumenter. Vi skal bruke denne figuren her}
\includegraphics[scale=0.5]{tangential_vel.png}\\
...
\hyperlink{kepler}{\pagebutton{Neste side}}
\end{frame}
...
\hyperlink{keplerja}{\pagebutton{JA!}}\ \ \ \ \ \hyperlink{keplernei}{\pagebutton{NEI!}}
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[] Så fint da! \hypertarget<.>{keplerja}{}
\end{itemize}
Da husker du kanskje også omtrent hva Keplers lover sier? Tenk deg godt om før du går videre!!!\\
 \hyperlink{keplernei}{\pagebutton{Få se Keplers lover da vel!}}
\pause
\begin{itemize}[<+->]
\item[] OK da, her er de: \hypertarget<.>{keplernei}{}
\end{itemize}
\begin{enumerate}
...
\end{enumerate}
Se gjerne \href{https://www.uio.no/studier/emner/matnat/astro/AST2000/h20/undervisningsressurser/interaktive-forelesningsnotater/1b/videoer/video1b_4.mp4}{denne videoen} hvis du er usikker på hva lovene sier.
...
{\Large
Merket du det forresten en viktig ting på forrige side og i videoen? I astrofysikken bruker vi enheten AU (Astronomial Unit), astronomiske enheter, veldig mye så lær deg med en gang hva denne betyr:}
...
\hyperlink{ellipseformel}{\pagebutton{Trykk her når du husker, ikke før!}}
\pause
\addtocounter{pageno}{-1}
{
\small
\begin{itemize}[<+->]
\item[] Ellipser: \hypertarget<.>{ellipseformel}{}
\end{itemize}
\[
...
\includegraphics[scale=0.4]{ellipse.png}\hspace*{-2cm}\hyperlink{kepler2}{\pagebutton{Neste side}}
\end{frame}
...
\hyperlink{kepler5b}{\pagebutton{ÅJA, dette kan jeg, la oss sette igang med utledningen!}}\\
\hyperlink{trengerep}{\pagebutton{Njaaaa...jeg trenger kanskje litt repetisjon}}
\pause
\addtocounter{pageno}{-1}
{
%\small
\begin{itemize}[<+->]
\item[] \hspace*{-1cm}\textcolor{red}{Bruk 'forrige side'-knappene til å gå bakover og repetere. Dette er viktig, ikke gå videre før du har kontroll, da blir alt bare så mye vanskeligere.} \hypertarget<.>{trengerep}{}
\end{itemize}
}
...
\includegraphics[scale=0.4]{forces.png}\\
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.37]{unityvectors_on_m1m2.png}
\column{0.5\textwidth}
{\Large 
\[
...
\includegraphics[scale=0.4]{harmosc.png}
...
\]
\end{block}
Prøv deg litt frem på papir til du finner en løsning!
\hyperlink{kepler14}{\pagebutton{Nå har jeg prøvd meg frem helt til jeg fant en løsning!}}
\end{frame}
...
Er du {\bf helt} sikker på at du har funnet riktig løsning?. Før du går videre nå, ta din løsning $u(\theta)$ og dobbeltderiver den!
...
\hyperlink{kepler17}{\pagebutton{Neste side}}
\end{frame}
...
\begin{frame}
\label{oppsummering}
\hyperlink{kepler17}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/158672}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}
Da er vi ved veis enda av den første forelesningen i del 1B. Du bør nå ha god oversikt over dette:
\begin{itemize}
