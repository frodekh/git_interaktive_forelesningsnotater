...
{
\small 
Velkommen til andre forelesning i del 1B! Til høyre er det noen punkter til repetisjon.
Kun når du har \textcolor{red}{\bf full kontroll} på alt dette kan du gå videre. Hvis ikke, gå tilbake til forrige forelesning for å repetere litt eller spør foreleser og/eller gruppelærer hvis det er ting som er uklare.\\
...
\includegraphics[scale=0.3]{ellipse.png}\hyperlink{conic1b}{\pagebutton{Neste side}}
\end{frame}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.3]{conicsections0.png}
\column{0.5\textwidth}
...
\hyperlink{conic3}{\pagebutton{Neste side}}
\end{columns}
\end{frame}

\begin{frame}
\label{conic3}
\dlastpagebutton{conic2}
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.3]{conicsections0.png}
...
\hyperlink{conic4}{\pagebutton{Neste side}}
\end{columns}
\end{frame}
...
\hyperlink{conic5}{\pagebutton{Neste side}}
\end{frame}
}
...
\includegraphics[scale=0.3]{oumuamua.png}
}}
...
\hyperlink{oppgaver1}{\pagebutton{Neste side}}
\end{frame}
...
Tenk gjennom hvordan du kan gå frem for å løse oppgave 1B.1 på høyre side her (prosjektstudenter har en liknende oppgave i utfording B1, del 2):
Etter at du har tenkte nøye, ta gjerne en titt på \href{https://www.uio.no/studier/emner/matnat/astro/AST2000/h20/undervisningsressurser/interaktive-forelesningsnotater/1b/videoer/video1b_9.mp4}{denne videoen} for noen tips. \textcolor{red}{Merk at det ikke er meningen at du skal løse oppgaven nå men finne din egen ide om hvordan du ville startet på hver av deloppgavene. Ikke se på videoen før du har egne forslag.}
\column{0.5\textwidth}
\hspace*{-0.5cm}\includegraphics[scale=0.43]{1b1.png}
...
\headlinebutton{\headline}\\
Tenk gjennom hvordan du kan gå frem for å løse deloppgave 1 og 3 fra oppgave 1B.2 på høyre side her (prosjektstudenter har en liknende oppgave i utfording B1, del 2):
Etter at du har tenkte nøye, ta gjerne en titt på \href{https://www.uio.no/studier/emner/matnat/astro/AST2000/h20/undervisningsressurser/interaktive-forelesningsnotater/1b/videoer/video1b_10.mp4}{denne videoen} for noen tips.\textcolor{red}{ Merk at det ikke er meningen at du skal løse oppgaven nå men finne din egen ide om hvordan du ville startet på hver av deloppgavene. Ikke se på videoen før du har egne forslag.}
\column{0.45\textwidth}
\hspace*{-0.5cm}\includegraphics[scale=0.43]{1b2.png}
...
\includegraphics[scale=0.4]{1b3.png}
...
\hyperlink{cm2}{\pagebutton{Neste side}}
\end{frame}
...
\includegraphics[scale=0.35]{cm1.png}\\
...
\]
og sett inn riktige indekser på krefter, masser, posisjonsvektorer og tidsderiverte. Pass spesielt på at summegrensene blir riktige!
...
\includegraphics[scale=0.17]{cm3.png}\\
...
\column{0.5\textwidth}
Da velger vi å flytte origo til massesenteret. Dette nye koordinatsystemet kaller vi massesentersystemet. Posisjonsvektorene $\vec{r_1}^{CM}$ og $\vec{r_2}^{CM}$ fra det nye origo er tegnet inn i figuren. Men hva med $\vec{R}^{CM}$. Hva er posisjonsvektoren til massesemnteret fra dette nye origo?\\
...
\end{block}
\hyperlink{feilr1}{\choicebutton{\small $\vec{r_1}=\hat\mu\vec{r}$}}\ \ \ \ \ \hyperlink{feilr1}{\choicebutton{\small $\vec{r_1}=\frac{m_1}{\hat\mu}\vec{r}$}}\ \ \ \ \ \hyperlink{feilr1}{\choicebutton{\small $\vec{r_1}=\frac{m_1}{\hat\mu}$}}\ \ \ \ \ \hyperlink{feilr1}{\choicebutton{\small $\vec{r_1}=-\frac{m_2}{\hat\mu}\vec{r}$}}\ \ \ \ \ \hyperlink{rettr1}{\choicebutton{\small $\vec{r_1}=-\frac{\hat\mu}{m_1}\vec{r}$}}\ \ \ \ \ \hyperlink{feilr1}{\choicebutton{\small $\vec{r_1}=-\frac{\hat\mu}{m_2}\vec{r}$}}\ \ \ \ \ \hyperlink{feilr1}{\choicebutton{\small $\vec{r_1}=\frac{m_1}{m_2}\hat\mu\vec{r}$}}
\end{frame}
...
\hyperlink{ja}{\choicebutton{JA, kult, nå ser jeg det!}}\ \ \ \ \ \hyperlink{nei}{\choicebutton{Kanskje det, men jeg er litt usikker}}
\end{frame}
}
...
\hyperlink{energi1}{\pagebutton{Neste side}}
\end{frame}
...
\hyperlink{fenergi}{\choicebutton{YES, absolutt, sånn må det være!}}\ \ \ \ \ \hyperlink{renergi}{\choicebutton{Njaaa, jeg er litt usikker}}
\end{frame}
...
\hyperlink{ffenergi}{\choicebutton{JA, jeg sa jo det jo!}}\ \ \ \ \ \hyperlink{renergi}{\choicebutton{Njaaa, nå ble jeg litt i tvil her likevel}}
\end{frame}
}
...
\includegraphics[scale=0.4]{1b4.png}\\
...
\column{0.5\textwidth}
\includegraphics[scale=0.4]{1b4_2.png}\\
\includegraphics[scale=0.4]{1b4_3.png}\\
...
\includegraphics[scale=0.35]{landing.png}
...
\hyperlink{koding2}{\pagebutton{Neste side}}
\end{columns}
\end{frame}
...
\includegraphics[scale=0.3]{debugging1.png}
{\small La oss helt til slutt snakke litt om debugging. Det kommer helt sikkert til å gå galt når du programmerer banen første gang. Her ser du et veldig typisk resultat. \\{\bf Spørsmålet er, hva gjør du nå???}\\}
\hyperlink{fdebug}{\choicebutton{{\small Stirrer på koden til du finner feilen}}}\ \ \ \ \ \hyperlink{fdebug}{\choicebutton{{\small Får noen andre til å stirre på koden}}}\ \ \ \ \ \hyperlink{rdebug}{\choicebutton{{\small Bruker fysikk til å finne i hvilken del av koden feilen befinner seg.}}}
\hyperlink{cm7}{\pagebutton{Neste side}}
\end{frame}
...
Rådene på neste side er nok da ikke for deg, men \hyperlink{rdebug}{\pagebutton{Trykk her}} hvis du likevel har lyst til å få noen tips til hvordan du kan spare masse tid, så kan du jo bruke all tiden du har til overs på andre oppgaver?}
\end{frame}
}
...
\includegraphics[scale=0.3]{debugging2.png}\\
\column{0.5\textwidth}
\begin{enumerate}
...
\includegraphics[scale=0.25]{debugging2.png}
{\small
