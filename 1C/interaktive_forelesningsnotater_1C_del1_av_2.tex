...
\newcommand{\lastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/160191}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\nextpage\headlinebutton{\showheadline}\\}
\newcommand{\clastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/160191}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\headlinebutton{\showheadline}\\}
\newcommand{\dlastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/160191}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\headlinebutton{\showheadline}\\}
...
\newcounter{pageno}
\newcounter{nopages}
\setcounter{nopages}{41}

\newcommand{\headline}{Introduksjon}
\newcommand{\showheadline}{\small\headline}
...
\includegraphics[scale=0.4]{1c4_1.png}\\
\includegraphics[scale=0.4]{1c4_2.png}\\
...
\href{https://nettskjema.no/a/155568}{\choicebutton{Nei}}\ \ \ \ \hyperlink{brainstormdone}{\choicebutton{Ja}}\\
...
\includegraphics[scale=0.4]{angular_distance.png}\\
{\small
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.25]{angular_distance.png}\\
...
\column{0.5\textwidth}
\includegraphics[scale = 0.3]{tangential_vel.png}\\
...
\hspace*{1cm}\includegraphics[scale=0.23]{resolution.png}\\
...
\begin{columns}
\column{0.5\textwidth}
\hspace*{1cm}\includegraphics[scale=0.2]{resolution.png}\\
...
\vspace*{2cm}
\hyperlink{nytema2}{\pagebutton{Ikke gå videre før du har svaret!}}
\end{frame}
}
...
\textcolor{yellow}{Nå kommer et laaaangt avsnitt. Etter at du er ferdig med dette temaet er det kaffepause! Men vi tar en liten pause underveis på side \ref{regning} av \thenopages}
\end{frame}
}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.2]{spectrum.png}\\
...
\includegraphics[scale=0.3]{halpha_sinus.png}\\
...
Husker du formelen for endring i bølgelengde pga. Dopplereffekten?\hyperlink{vr3b}{\pagebutton{Trykk her når du har tenkt...}}
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[] Ganske riktig  \hypertarget<.>{vr3b}{}
\end{itemize}
\[
...
\includegraphics[scale=0.28]{halpha_sinus.png}\\
Ta et papir, tegn akser og bruk figuren samt Dopplerformelen til å tegn hastighetskurven til stjerna som funksjon av tiden. Altså tid på x-aksen og hastighetskomponent $v_r$ på y-aksen. Forresten hvorfor kun hastighetskomponenten $v_r$? \hyperlink{vr5b}{\pagebutton{Tenk før du trykker her}}\\
\column{0.5\textwidth}
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[]  \hypertarget<.>{vr5b}{}
\end{itemize}
...
\]
der $v_r$ er radialkomponenten, hastighetskomponenten rett mot/fra observatøren. \textcolor{red}{Tangensialhastigheten (hastighet vinkelrett på synsretningen til observatøren) bidrar ikke til Dopplereffekt.} {\bf Da er alt klart til å tegne hastighetsplottet for $v_r$. Ikke gå videre før du har et omtrentlig plott!}
...
\hyperlink{vr6b}{\pagebutton{Tenk før du trykker her}}
\pause
\addtocounter{pageno}{-2}
\begin{itemize}[<+->]
\item[]  \hypertarget<.>{vr6b}{}
\end{itemize}
\vspace*{-0.5cm}
...
\hyperlink{vr7b}{\pagebutton{Diskuter før du går videre!}}
\pause
\addtocounter{pageno}{-3}
\begin{itemize}[<+->]
\item[]  \hypertarget<.>{vr7b}{}
\end{itemize}
\vspace*{-0.5cm}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.38]{vr.png}\\
\column{0.5\textwidth}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.2]{vr.png}\\
\[
P^2=\frac{4\pi^2a^3}{G(m_1+m_2)}
\]
...
Fant du det ut??? Planeten går i en sirkelbane med lengde $2\pi a$, og tar en tid $P$ på å komme rundt. Da blir farta...\\\hyperlink{vr11c}{\pagebutton{...trykk her når du har svaret...}}
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[]  \hypertarget<.>{vr11c}{}
\end{itemize}
\vspace*{-0.5cm}
...
\]
der $m_p$ er planetens masse, $m_*$ er stjernas masse, $v_*$ er stjernas banehastighet omkring massesenteret og $v_p$ er planetens banehastighet om massesenteret. Når du har regnet litt og tenkt litt, ... \hyperlink{vr11d}{\pagebutton{... trykk her}}
\pause
\addtocounter{pageno}{-2}
\begin{itemize}[<+->]
\item[]  \hypertarget<.>{vr11d}{}
\end{itemize}
\vspace*{-0.5cm}
...
\hyperlink{vr13b}{\pagebutton{Trykk her når du har svaret!}}
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[]  \hypertarget<.>{vr13b}{}
\end{itemize}
\vspace*{-0.5cm}
...
\vspace*{0.5cm}
\hyperlink{nytema3}{\pagebutton{Jeg lover, jeg har tatt pause og er klart til å fortsette}}
\end{frame}
}
...
\begin{columns}
\column{0.6\textwidth}
\includegraphics[scale=0.6]{inklinasjon.png}\\
\column{0.4\textwidth}
I figuren har vi definert 
\begin{block}{\bf inklinasjonen}
som er vinkelen $i$ mellom {\bf normalen} til baneplanet og synslinja!
\end{block}
...
\hyperlink{mp9b}{\pagebutton{Trykk her når du har tenkt litt på det}}
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[]  \hypertarget<.>{mp9b}{}
\end{itemize}
\vspace*{-0.5cm}
...
\begin{columns}
\column{0.6\textwidth}
\includegraphics[scale=0.5]{eclipse.png}\\
\column{0.4\textwidth}
...
\begin{columns}
\column{0.6\textwidth}
\includegraphics[scale=0.45]{eclipse2.png}\\
\column{0.4\textwidth}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.4]{eclipse2.png}\\
...
\column{0.5\textwidth}
Planeten beveger seg da en strekning $2R_p$ i løpet av tiden $t_1-t_0$ med hastighet $v_p$, {\bf eller er det nå egentlig riktig å bruke hastigheten $v_p$???}. Hastigheten $v_p$ er i forhold til massesenteret. Det viser seg å være en god tilnærmelse, men kan du se hva vi egentlig skulle brukt?\\
\hyperlink{mp11b}{\pagebutton{Trykk her når du har tenkt}}
\pause
\addtocounter{pageno}{-1}
\begin{itemize}[<+->]
\item[]  \hypertarget<.>{mp11b}{}
\end{itemize}
\vspace*{-1cm}
...
\small Hvis du har både masse og radius til planeten, kan du også finne tetthet
\[
...
\small Hvis en planet har vanndamp i atmosfæren, får vi absorpsjonslinjer i vanndamp når atmosfæren kommer foran stjernen. Hvis atmosfæren ikke absorberer andre bølgelengder, vil vi måle en større radius for planeten med spektrallinja til vanndamp siden skiven som absorberer vanndamp omfatter planeten med atmosfæren rundt. Når du måler radiusen med andre deler av spektret som ikke absorberes av vanndamp vil du da måle en mindre radiuse som kun omfatter selve planeten uten atmosfæren.
\end{block}
