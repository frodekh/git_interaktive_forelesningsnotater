...
\lastpagebutton{feil_litenvinkel4} 
\begin{columns}
\column{0.5\textwidth}
...
\begin{frame}
\label{litenvinkel6}
\lastpagebutton{feil_litenvinkel5}
\includegraphics[scale=0.4]{media/angular_distance.png}\\
...
{\Huge\centerline{\textcolor{white}{Hva fikk du??}}}
\centerline{\bf \textcolor{white}{Ble avstanden større eller mindre enn 1 AU? (avstanden sol-jord)}}
\vspace*{0.5cm}
\textcolor{white}{Ville du kunne avbilde en planet i avstand 1AU fra en av våre nærmeste stjerner? Hva med en planet i samme avstand som Jupiter i vårt solsystem?}\\
\textcolor{white}{Hvis du sliter med å få dette til spør på} \forumbutton
\vspace*{2cm}
...
\begin{columns}
\column{0.5\textwidth}
\lastpagebutton{pause_vr8c}\label{regning}
...
\begin{frame}
\label{mp6}
\lastpagebutton{red_mp5}\label{inklinasjon}
...
\Large
Trykk nå gjerne på smilefjesene og si meninga di om dette interaktive forelesningsnotatet. Spesielt er jeg interessert i å vite hvor lang tid du brukte og da hva du brukte mest tid på! All ris og ros mottaes med takk.
\end{frame}
