...
\vspace{1cm}
\includegraphics[scale=0.22]{extrasolarplanets.png}\\
\column{0.5\textwidth}
\small Velkommen til andre forelesning av del 1C! Vi skal begynne med å bruke det du lærte i første forelesning på noen eksempler. Deretter skal vi se hvordan vi kan analysere data med støy, og du skal lære å estimere planetmasser fra mer realistiske stjernedata. \\{\bf Er du klar?}\\\vspace*{1cm}\hyperlink{intro2}{\pagebutton{Neste side}}
...
\[
m_p=\left(\frac{P}{2\pi G\sin{i}}\right)^{1/3}m_*^{2/3}v_*
\]
der $P$ er omløpsperioden, $i$ er inklinasjonen ({\bf husker du hvordan den er definert? Hvis ikke, gå tilbake og sjekk nå!)}, stjernas masse $m_*$ som vi kan regne som kjent og til slutt $v_*$ som er stjernas banehastighet i banen om massesenteret. Dopplereffekten gjør at vi kan finne stjernas radialhastighet {\bf (sjekk at du husker definisjon av radialhastighet og tangensialhastighet fra observatøren)} på forskjellige tidspunkter ved å se på bølgelegnden til en spektrallinje. Fra hastighetskurven til stjerna (radialhastiheten $v_r(t)$ som funksjon av tiden) kan vi finne banehastigheten $v_*$ til stjerna {\bf(sjekk at du husker hvordan du leser den av fra kurven)}.\\
...
\hyperlink{eks1}{\pagebutton{Neste side}}
}
\end{frame}
...
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.45]{1c3_1.png}\\
...
\hyperlink{fv}{\choicebutton{0m/s}}\ \hyperlink{fv}{\choicebutton{2500m/s}}\ \hyperlink{fv}{\choicebutton{2475m/s}}\ \hyperlink{rv}{\choicebutton{2300m/s}}\ \hyperlink{fv}{\choicebutton{2125m/s}}\ \hyperlink{fv}{\choicebutton{2100m/s}}\ \hyperlink{fv}{\choicebutton{400m/s}}\ \hyperlink{fv}{\choicebutton{175m/s}}\ 
\end{columns}
\end{frame}
...
Bra! Du ser ut til å ha forstått hastighetskurven og at egenhastigheten er massesenterets hastighet. Hvis du likevel skulle være litt i tvil, så kikk gjerne på \href{x}{denne videoen} som forklarer det i litt detalj.
...
\hyperlink{fv2}{\choicebutton{0m/s}}\ \hyperlink{fv2}{\choicebutton{2500m/s}}\ \hyperlink{fv2}{\choicebutton{2475m/s}}\ \hyperlink{fv2}{\choicebutton{2300m/s}}\ \hyperlink{fv2}{\choicebutton{2125m/s}}\ \hyperlink{fv2}{\choicebutton{2100m/s}}\ \hyperlink{fv2}{\choicebutton{400m/s}}\ \hyperlink{rv2}{\choicebutton{175m/s}}\ 
\end{columns}
\end{frame}
...
\includegraphics[scale=0.32]{vr.png}\\
\column{0.5\textwidth}
...
\label{eks3}
\lastpagebutton{rv2}
Hvis vi nå antar at inklinasjonen er ukjent, gjør et estimat av den minste mulige massen som denne planeten må ha. Anta at man ved spektroskopi har anslått stjernas masse til å være $0.3\mathrm{m}_\odot$ (merk at vi bruker $\mathrm{m}_\odot$ til å markere solmasser), altså en liten rød dvergstjerne.
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.45]{1c3_1.png}\\
\column{0.5\textwidth}
Er den minste mulige massen:
\hyperlink{fp}{\choicebutton{ca. 0.5 Jupitermasser}}\ \hyperlink{rp}{\choicebutton{ca. 0.9 Jupitermasser}}\ \hyperlink{fp}{\choicebutton{ca. 1.3 Jupitermasser}}\ \hyperlink{fp}{\choicebutton{ca. 2.1 Jupitermasser}}\ \hyperlink{fp}{\choicebutton{ca. 2.8 Jupitermasser}}\ \hyperlink{fp}{\choicebutton{ca. 3.5 Jupitermasser}}\ \hyperlink{fp}{\choicebutton{ca. 4.9 Jupitermasser}}
\end{columns}
\end{frame}
...
\label{eks4}
\lastpagebutton{rp}
Som du ser blir det ganske høy usikkerhet da det er vanskelig å lese av $P$ og $v_*$ nøyaktig med støy på kurven. Dette skal vi se nærmere på senere i denne forelesningen. Men først skal vi jobbe litt mer med oppgave 1C.3. Vi fortsetter med den samme stjerna, men observasjoner av lyskurven viser at planeten formørker stjerna. Her ser vi utdrag av lyskurven fra en formørkelse:
\begin{columns}
\column{0.5\textwidth}
\includegraphics[scale=0.45]{1c3_2.png}\\
Gi et anslag på radiusen og tettheten til planeten. Du trenger kanskje å repetere fra forrige forelesning hvordan du finner planethastigheten (i forhold til CM) når du har stjernehastigheten. 
\column{0.5\textwidth}
...
\vspace*{0.3cm}
\hyperlink{fp2}{\choicebutton{\small ca. 0.5 Jupiterradier}}\ \hyperlink{fp2}{\choicebutton{\small ca. 0.9 Jupiterradier}}\ \hyperlink{rp2}{\choicebutton{\small ca. 1.3 Jupiterradier}}\ \hyperlink{fp2}{\choicebutton{\small ca. 2.1 Jupiterradier}}\ \hyperlink{fp2}{\choicebutton{\small ca. 2.8 Jupitradier}}\ \hyperlink{fp2}{\choicebutton{\small ca. 3.5 Jupiterradier}}
\end{columns}
\end{frame}
...
\label{stat1}
\lastpagebutton{eks5}
\includegraphics[scale=0.35]{vr_noisy.png}\\
{\small
...
\includegraphics[scale=0.3]{vrmod.png}\\
{\small
...
\hyperlink{fm}{\choicebutton{ $v_r(t)=v_*\sin{\frac{2\pi}{\theta(t)}}$}}\ \hyperlink{rm}{\choicebutton{ $v_r(t)=v_*\cos{\frac{2\pi}{\theta(t)}}$}}\ \hyperlink{fm}{\choicebutton{ $v_r(t)=v_*\sin{\theta(t)}$}}\ \hyperlink{fm}{\choicebutton{ $v_r(t)=v_*\cos{\theta(t)}$}}\ \hyperlink{fm}{\choicebutton{ $v_r(t)=v_*\cos{\theta(t)}\sin{\theta}$}}\ \hyperlink{fm}{\choicebutton{ $v_r(t)=v_*\tan{\theta(t)}$}}
\end{columns}
\end{frame}
...
\]
\column{0.5\textwidth}
Men for å ha en komplett modell, trenger vi også tidsavhengigheten til $\theta(t)$. Vi skal uttrykke den med omløpsperioden $P$. lEr den:\\
\hyperlink{fm2}{\choicebutton{ $\theta(t)=2\pi Pt$}}\ \hyperlink{fm2}{\choicebutton{ $\theta(t)=\frac{P}{t}$}}\ \hyperlink{fm2}{\choicebutton{ $\theta(t)=P\cos{2\pi t}$}}\ \hyperlink{fm2}{\choicebutton{ $\theta(t)=\frac{2\pi P}{t}$}}\ \hyperlink{fm2}{\choicebutton{ $\theta(t)=\frac{t}{P}$}}\ \hyperlink{rm2}{\choicebutton{ $\theta(t)=\frac{2\pi t}{P}$}}
\end{columns}
\end{frame}
...
\includegraphics[scale=0.25]{vr_noisy.png}\\
\vspace*{0.5cm}
...
{\Huge
Er du helt sikker på at du har tenkt godt gjennom dette? Har du fått noen ideer? Tenk litt til før du går videre!
}
\hyperlink{stat7}{\pagebutton{Neste side}}
\end{frame}
...
\includegraphics[scale=0.22]{vr_noisy.png}\\
Vi skal finne den røde linja som passer best til de observerte datene med støy.
\column{0.5\textwidth}
...
\]
\column{0.5\textwidth}
Men hvordan defineres {\bf den minste forsjellen?}. Det er rett og slett {\bf forskjell} slik vi vanligvis omtaler en forskjell: \textcolor{red}{datakurven minus modellkurven. Men vi opphøyer denne forsjellen i annen potens}, derav navnet {\bf minste kvadrat}. Dette er for å få absoluttverdien, det er ikke viktig om forskjellen er negativ eller positiv. Det finnes også en statisik begrunnelse for å ta kvadratet, denne kommer snart.
...
\[
P(x) = \frac{1}{\sqrt{2\pi}}e^{-\frac{1}{2}\frac{(x-\mu)^2}{\sigma^2}}
\]
Hvis middelverdien for støyen er 0, noe den ofte er, og standardavviket er $\sigma_n$, så bli jo det da rett og slett:
\[
P(\delta v_i) = \frac{1}{\sqrt{2\pi}}e^{-\frac{1}{2}\frac{\delta v_i^2}{\sigma_n^2}}
\]
...
\includegraphics[scale=0.3]{twosigma.png}\\
...
\hyperlink{fn}{\choicebutton{\small $\sigma_n^A\approx 1930$m/s og $\sigma_n^B\approx 1900$m/s}}\ \hyperlink{fn}{\choicebutton{\small $\sigma_n^A\approx 140$m/s og $\sigma_n^B\approx 200$m/s}}\ \hyperlink{fn}{\choicebutton{\small $\sigma_n^A\approx 30$m/s og $\sigma_n^B\approx 80$m/s}}\ \hyperlink{fn}{\choicebutton{\small $\sigma_n^A\approx 15$m/s og $\sigma_n^B\approx 40$m/s}}\ \hyperlink{rn}{\choicebutton{\small $\sigma_n^A\approx 7$ m/s og $\sigma_n^B\approx 20$m/s}}
\hyperlink{stat13}{\pagebutton{\small Neste side}}
\end{frame}
...
\includegraphics[scale=0.3]{noise_zoom.png}\\
\end{frame}
}
...
Flott! Du fikk det til. Det betyr at du forstår hva det betyr at støyen er Gaussisk fordelt og hva en Gaussisk fordeling er. Hvis du nå likevel er litt usikker, ta en titt på \href{x}{denne videoen}.
...
\label{stat13}
\clastpagebutton{rn}
\includegraphics[scale=0.25]{twosigma.png}\\
{\small 
...
{\bf Tenk deg godt om før du går videre!}
}
...
La oss fortsette med statitsikken. Vi fant at sannsynligheten for at støyen i observasjon $i$ er gitt ved
\[
P(\delta v_i) = \frac{1}{\sqrt{2\pi}}e^{-\frac{1}{2}\frac{\delta v_i^2}{\sigma_n^2}}
\]
...
\[
P(\delta v_i) = \frac{1}{\sqrt{2\pi}}e^{-\frac{1}{2}\frac{\delta v_i^2}{\sigma_i^2}}
\]
Enig? \hyperlink{ja}{\choicebutton{Ja}}\ \hyperlink{nei}{\choicebutton{Nei}}
\end{frame}
...
\hyperlink{ja}{\pagebutton{Neste side}}
\end{frame}
}
...
\[
P(\delta v_0, \delta v_1, \delta v_2, ..., \delta v_N)) = \prod_{i=1}^N\frac{1}{\sqrt{2\pi}}e^{-\frac{1}{2}\frac{\delta v_i^2}{\sigma_i^2}}
\]
...
\[
P(\delta v_0, \delta v_1, \delta v_2, ..., \delta v_N) = \left(\frac{1}{\sqrt{2\pi}}\right)^Ne^{-\frac{1}{2}\sum_{i=1}^N\frac{\delta v_i^2}{\sigma_i^2}}
\]
...
\[
P(\delta v_0, \delta v_1, \delta v_2, ..., \delta v_N) = \left(\frac{1}{\sqrt{2\pi}}\right)^Ne^{-\frac{1}{2}\sum_{i=1}^N\frac{(v_r^\mathrm{obs}(t_i)-v_r^\mathrm{real}(t_i))^2}{\sigma_i^2}}
\]
...
\[
P(\delta v_0, \delta v_1, \delta v_2, ..., \delta v_N) = \left(\frac{1}{\sqrt{2\pi}}\right)^Ne^{-\frac{1}{2}\sum_{i=1}^N\frac{(v_r^\mathrm{obs}(t_i)-v_r^\mathrm{mod}(t_i))^2}{\sigma_i^2}}
\]
...
\hyperlink{obs}{\choicebutton{Si det...}}\ \hyperlink{obs}{\choicebutton{noe renspikka tull!}}\ \hyperlink{obs}{\choicebutton{Newtons 2.lov!}}\ \hyperlink{obs}{\choicebutton{Maxwell-Boltzmann!}}\ \hyperlink{obs}{\choicebutton{Teorien om alt}} \hyperlink{puh}{\choicebutton{Minste kvadraters metode}}
\end{frame}
...
\begin{frame}
\label{obs}
Hmmm, du har kanskje ikke fulgt så godt med?? Eller kanskje du falt av litt tidligere? Eller kanskje du var nysjerrig på hva som kom her? Du trenger nok å reptere litt av det grunnleggende som vi har gått gjennom før du kommer hit på nytt
\hyperlink{stat19}{\pagebutton{Trykk her!}}
\end{frame}
}
...
\hyperlink{stat20}{\pagebutton{Neste side}}
\end{frame}
}
