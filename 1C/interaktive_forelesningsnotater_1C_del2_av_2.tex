...
\newcommand{\clastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/160191}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\headlinebutton{\headline}\\}
\newcommand{\dlastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/160191}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\headlinebutton{\headline}\\}
...
\newcounter{pageno}
\newcounter{nopages}
\setcounter{nopages}{44}

\newcommand{\headline}{\small Repetisjon}
...
\hyperlink{nytema1}{\pagebutton{Neste side}}
}
\end{frame}
...
\hyperlink{nytema2}{\pagebutton{Jeg har sendt inn skjemaet og er klar for dataanalyse-delen}}
\end{frame}
...
\hyperlink{sikker}{\pagebutton{Neste side}}
\end{columns}
\end{frame}
}
...
\begin{frame}
\label{sikker}
\hyperlink{rm2}{\pagebutton{\small Forrige side}}
...
\vspace*{0.5cm}
\hyperlink{nytema4}{\pagebutton{Jeg lover, jeg har tatt pause og er klart til å fortsette}}
\end{frame}
}
...
\hyperlink{stat8b}{\pagebutton{\small Forrige side}}
\nytemaside{tips}
\hyperlink{stat9}{\pagebutton{Sett igang med nytt tema!}}
\end{frame}
}
...
\centerline{\includegraphics[scale=0.3]{noise_zoom.png}}
\end{frame}
}
...
\hyperlink{litenpause}{\pagebutton{Neste side}}
\end{frame}
}
...
\begin{frame}
\label{litenpause}
\hyperlink{puh}{\pagebutton{\small Forrige side}}
{\Large
...
\hyperlink{loping}{\pagebutton{Neste side}}
\end{frame}
}
...
\begin{frame}
\label{loping}
\hyperlink{litenpause}{\pagebutton{\small Forrige side}}
{\Huge
\centerline{Hvor mange ganger ble det???}\\
\vspace*{1cm}
\hyperlink{lite}{\choicebutton{1/2 gang: kun ned trappa}}\ \hyperlink{lite2}{\choicebutton{$<2$}}\ \hyperlink{lite2}{\choicebutton{$<5$}}\ \hyperlink{lite2}{\choicebutton{$<10$}}\ \hyperlink{bra}{\choicebutton{$\geq10$}}
}
\end{frame}
}
...
\hyperlink{litenpause2}{\pagebutton{Neste side}}
\end{frame}
}
...
\hyperlink{litenpause2}{\pagebutton{Jepp, nå fikk jeg 50 ganger...}}
\end{frame}
}
...
\begin{frame}
\label{litenpause2}
\hyperlink{loping}{\pagebutton{\small Forrige side}}
...
\includegraphics[scale=0.25]{vr_nomod.png}\\
...
\centerline{\includegraphics[scale=0.5]{vr_t0_int.png}}
...
\centerline{\includegraphics[scale=0.25]{vr_p_int.png}}
...
\centerline{\includegraphics[scale=0.25]{vr_wrongmod.png}}
...
\centerline{\includegraphics[scale=0.2]{vr_wrongmod.png}}
