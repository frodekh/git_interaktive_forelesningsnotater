...
\newcommand{\clastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/173961}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\headlinebutton{\headline}\padletbutton\\}
\newcommand{\dlastpagebutton}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/173961}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\headlinebutton{\headline}\padletbutton\\}
...
\newcommand{\clastpagebuttoncr}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/173961}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\curpage\\\headlinebutton{\headline}\padletbutton\\}
\newcommand{\dlastpagebuttoncr}[1]{\hyperlink{#1}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/173961}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\dnextpage\\\headlinebutton{\headline}\padletbutton\\}
...
\begin{frame}
\label{front}
\center{\Large \textcolor{darkscarlet}{\bf AST2000 Del 2D og 2E\\Interaktive forelesningsnotater}}\\
\vspace*{1cm}
...
Dette er en erstatning for forelesningen i emnet. \textcolor{blue}{Har du gått skikkelig gjennom disse interaktive forelesningsnotatene så trenger du ikke å lese de fulle forelesningsnotatene i \href{https://www.uio.no/studier/emner/matnat/astro/AST2000/h20/undervisningsmateriell/lecture_notes/part2d.pdf}{del 2d} og \href{https://www.uio.no/studier/emner/matnat/astro/AST2000/h20/undervisningsmateriell/lecture_notes/part2e.pdf}{del 2e} (med unntak av oppgavene bak)}. All informasjonen du trenger, får du her. Du kommer til å få mange grublespørsmål og diskusjonsoppgaver, det er meningen at disse skal gjøres i grupper av minst 2, maks 4 studenter. {\bf Det er defor sterkt anbefalt at dere sitter sammen i grupper når dere går gjennom disse interaktive forelesningsnotatene, du vil få betydelig mer utbytte av dem på den måten}. En god ide kan være å bli enige om å treffes til den faste forelesningstiden og bruke forelesningslokalet som kommer til å være resevert til dette. {\bf Hvis du har kommentarer ris/ros til disse forelesningsnotatene eller til emnet, trykk på \href{https://nettskjema.no/a/173961}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}\ knappen som du finner på alle sider.}
\end{block}
%\setbeamercolor{button}{bg=black,fg=yellow}
...
\textcolor{red}{\bf Normalt kommer jeg frem til side 56 i en fysisk dobbelttime og tar resten på neste forelesning. Det bør du også gjøre!}
...
\href{https://nettskjema.no/a/173963}{\choicebutton{Nei}}\ \ \ \ \hyperlink{brainstormdone}{\choicebutton{Ja}}\\
...
\hyperlink{eu1}{\pagebutton{Euler igjen?}}
\end{frame}
}
...
\centerline{\includegraphics[scale=0.5]{rocket.png}}
...
\centerline{\includegraphics[scale=0.5]{rocket.png}}
Vi skal altså finne endringene $\Delta t$, $\Delta\phi$ og $\Delta r$ etter et egettidsintervall $\Delta\tau$. La oss begynne med $\Delta t$, har du noe forslag?\hyperlink{eu4b}{\choicebutton{Tror det!}}\hyperlink{eu4a}{\choicebutton{Næææææææ...}}
}

\colfullframe{eu4a}{eu4}{eu5}{0}{black}{\Huge
\textcolor{yellow}{
La meg gi deg et hint: kan du bruke en av formlene på første side her???
}
}

\colfullframe{eu4b}{eu4}{eu5}{-1}{yellow}{\Huge
Innebærer forslaget ditt et av formlene på første siden her?
}


\fullframe{eu5}{eu4}{eu6}{0}{\Large
Fikk du
\[
\Delta t=\frac{E/m}{1-\frac{2M}{r}}\Delta\tau
\]
?????
Hvor fikk du det fra?\pagequestion{gps3b}{Jo, det var jo...}{-1}
{\bf Uttrykket for energi på førstesiden!}
}


\fullframetxt{eu6}{eu5}{eu7}{1}{AHH, ok har det!}{\Large
Hva med endringen i vinkel, $\Delta\phi$?? Kan du se hvordan den må oppdateres for et gitt egentidsintervall $\Delta\tau$...?
\hyperlink{eu7}{\choicebutton{Jepp, jeg har uttrykket klart!}}   \pagequestion{eu6b}{Et hint kanskje?}{-2}
...
\fullframe{eu12}{eu11}{eu13}{0}{\huge
...
\fullframe{eu14}{eu13}{eu15}{0}{\Huge
...
\Delta r=\pm\sqrt{\left(\frac{E}{m}\right)^2-\left[1+\left(\frac{L/m}{r}\right)^2\right]\sst}\Delta\tau.
\]
Ta en kikk på disse likningen! Kan du se hvordan du kan finne Euler-likningene for lys? Altså hvordan oppdatering $\Delta r$ og $\Delta\phi$ blir for en gitt $\Delta t$? Ikke gå videre før du har et forslag! Og husk at fotoner er masseløse, $m=0$!
}

\fullframe{eu16}{eu15}{eu17}{0}{
Fikk du
\[
...
\]
{\Huge ???}
\hyperlink{eu17}{\choicebutton{Dette fikk jeg til, gå videre!}}\\  \pagequestion{eu16b}{Kom ikke helt imål, hint?}{-1}
...
\colfullframe{eu17b}{eu17}{eu17c}{0}{denim}{\textcolor{yellow}{\small
\centerline{\includegraphics[scale=0.2]{radvel.png}}
...
\colfullframetxt{eu17c}{eu17b}{eu17d}{0}{denim}{\footnotesize NEI, VIL IKKE!}{\textcolor{yellow}{\footnotesize
{\large
\[
\Delta r=\pm \sst\sqrt{1-\sst\frac{(L/E)^2}{r^2}}\Delta t
\]
}
{\bf Fikk du det til?} {\bf Eller kanskje du ikke tror på svaret ditt?}\pagequestion{eu17x}{\footnotesize Et lite hint for sikkerhetsskyld?}{-1}
...
\pagequestion{eu17y}{\footnotesize Jo det er jo...}{0}
Nettopp!$v_r=\frac{\Delta r}{\Delta t}$ og den får du rett fra disse likningen. Men hva er spinnet $L$ for denne lysstrålen?\pagequestion{eu17z}{\footnotesize Jammen det er jo...}{0}
Ikke sant| Lysstrålen går jo radielt innover, så den har jo ikke noe spinn. Men hva blir lysfarta da?\pagequestion{eu17w}{\footnotesize NEI, IKKE TALE OM!}{0}
Det blir jo
\[
v_r=-\sst
\]
(merk minustegn siden lyset faller {\bf innover})\pagequestion{eu17q}{{\footnotesize\bf Ikke tale om sa jeg! Du lurer ikke meg!}}{0}
Ikke noe lureri her, lover!
}
}

\colfullframe{eu17d}{eu17c}{eu17h}{1}{denim}{\textcolor{yellow}{
\centerline{\includegraphics[scale=0.2]{radvel.png}}
{\large
\[
v_r=\sst
...
Jo, faktisk! Lureriet var i del 2A og 2B da vi sa at lysets hastighet er den samme for alle observatører. Her ser vi at lengt-vekkobservatøren {\bf ikke} måler en lyshastighet på $1$. Men hvilken lysfart får vi når $r$ nærmer seg eventhorisonten?\pagequestion{eu170}{{\footnotesize\bf SLUTT! Nå går du over streken!}}{-2} Nettopp, ja, lysfarta går mot null ved eventhorisonten {\bf den også!}. {\bf Vel og merke målt fra en langt-vekkobservatør!}.
}
}


\colfullframe{eu17h}{eu17d}{eu17e}{2}{denim}{\textcolor{yellow}{\footnotesize
\centerline{\includegraphics[scale=0.1]{radvel.png}}
{\large
\[
v_r=-\sst
\]
...
\colfullframe{eu17e}{eu17h}{pause}{0}{denim}{\textcolor{yellow}{
\[
\Delta r=\pm \sst\sqrt{1-\sst\frac{(L/E)^2}{r^2}}\Delta t
\]
\[
...
\begin{frame}
\label{pause}
\hyperlink{eu17e}{\pagebutton{\small Forrige side}}
{\huge
\centerline{Kaffe!}
...
\\
\vspace*{0.5cm}
\hyperlink{eu18}{\pagebutton{Jeg har kommet meg, hodet er klart, sett igang!}}
\end{frame}
}
...
\colfullframe{eu18}{eu17e}{eu19}{0}{denim}{\textcolor{yellow}{\small
\centerline{\includegraphics[scale=0.1]{impact1.png}}
...
\colfullframe{eu19}{eu18}{eu20}{0}{denim}{\textcolor{yellow}{\small
\centerline{\includegraphics[scale=0.2]{impact1.png}}
...
\colfullframe{eu20}{eu19}{eu21}{0}{denim}{\textcolor{yellow}{\small
\centerline{\includegraphics[scale=0.2]{impact2.png}}
...
\colfullframe{eu21}{eu20}{eu22}{0}{denim}{\textcolor{yellow}{\small
\centerline{\includegraphics[scale=0.2]{impact2.png}}
{\Huge Fikk du det til???}
}
}

\colfullframe{eu22}{eu21}{eu23}{0}{denim}{\textcolor{yellow}{\small
\centerline{\includegraphics[scale=0.2]{impact2.png}}
Fikk du
\[
b=\frac{L}{E}
...
\fullframe{eu23}{eu22}{eu24}{0}{
Setter vi inn får vi
\begin{align*}
\frac{dr}{dt}&=\pm\sst\sqrt{1-\sst\frac{b^2}{r^2}}\\
r\frac{d\phi}{dt}&=\pm\frac{b}{r}\sst.
\end{align*}
Merk at vi nå har gjort $\Delta$-ene infinitesimalt små slik at de har blitt til $d$-er. Merk også at vi har $rd\phi/dt$ på venstre side isteden for bare $d\phi/dt$, kan du se hvorfor? \pagequestion{eu23b}{Njaaaa, kanskje.}{-1} Husker du at vi i celestmekanikken fant at tangensialhastighet er $v_\phi=r\dot{\phi}$? Ja, det er nettopp den du har på venstre side nederst! Og øverst har du radiell hastighet til lyset. {\bf Alt sett fra langt-vekkobservatøren selvfølgelig!}
}

\fullframe{eu24}{eu23}{nytema2}{1}{
...
\fullframe{skra1}{eu24}{skra2}{0}{\label{skraplan}
\centerline{\includegraphics[scale=0.2]{skraplan1.png}}
...
\centerline{\includegraphics[scale=0.15]{skraplan1.png}}
...
\centerline{\includegraphics[scale=0.15]{skraplan2.png}}
\[
E=\frac{1}{2}mv^2+mgh(x)
\]
...
\centerline{\includegraphics[scale=0.15]{skraplan4.png}}
...
\fullframe{skra9}{skra8}{nytema3}{0}{
\[
A=Bv^2+V(x)
\]
...
\nytemaside{lys}
\textcolor{yellow}{\Large En skikkelig strekk på bena nå! Legg deg gjerne på sofaen, sett vekkeklokka på 20 min, lukk øynene! {\bf På en normal fysisk dobbelttime kommer jeg omtrent til side 56. Anbefaler at du også stopper når du nå start kommer til side 56 og da venter til imorgen med resten av denne forelesningen.}}
\hyperlink{skra10}{\pagebutton{Gå på!}}
\end{frame}
}


\fullframetxt{skra10}{skra9}{skra11}{0}{Tjaaaa......ikke helt rett frem det der nei...}{\label{effpot}\small
Høres dette litt kjent ut? La oss se om vi kan finne et system som likner. {\bf Hva med to-legeme-problemet}? La oss anta et lite legeme med masse $m$ i gravitasjonsfeltet fra en planet eller stjerne med masse $M$. Da kan vi i det Newtonske tilfellet hvor vi antar at $m$ ikke påvirker $M$ skrive at...\pagequestion{skra10b}{Ja, hvordan blir uttrykket for energi her?}{-1} Fikk du
\[
...
\fullframetxt{skra11}{skra10}{skra12}{1}{Klart det, skal bare sjekke del 1B en gang til}{
\[
\frac{E}{m}=\frac{1}{2}v^2+V(r)
\]
...
\]
men hva er $v_r$ og $v_\theta$ her? Uttrykk svaret med størrelsene $r$ og $\theta$ og deres tidsderiverte.\pagequestion{skra11b}{Dette bare {\bf må} jeg få til, la meg tenke litt...}{-2} Fikk du...\pagequestion{skra11c}{ja, jeg fikk...}{0}
\[
...
\centerline{\includegraphics[scale=0.15]{skraplan5.png}}
...
\centerline{\includegraphics[scale=0.15]{skraplan6.png}}
...
\fullframe{skra17}{skra16}{skra18}{0}{
...
\colfullframe{skra18}{skra17}{skra19}{0}{red}{
\textcolor{yellow}{{\Huge
Fikk du det til? Hvis ikke gi det et par forsøk til!\pagequestion{skra18b}{Et lite hint kan du få!}{-1}}
Du trenger kun
\[
\frac{dr}{d\tau}=\pm\sqrt{\left(\frac{E}{m}\right)^2-\left[1+\left(\frac{L/m}{r}\right)^2\right]\sst}
\]
...
\fullframe{skra19}{skra18}{skra20}{1}{\small
...
\centerline{\includegraphics[scale=0.15]{skraplan7.png}}
...
\fullframetxt{skra21}{skra20}{skra22}{0}{Jeg har tenkt meg godt om!}{\footnotesize
\centerline{\includegraphics[scale=0.13]{skraplan7.png}}
Forskjellene er...\pagequestion{skra21b}{\footnotesize ...jeg har det...}{-1}
{\bf For det første} at det nye skråplanet vårt ikke fortsetter uendelig høyt opp når $r\rightarrow 0$. Det har en topp og forsvinner så {\bf NEDOVER}.\pagequestion{skra21c}{\footnotesize Den var tydelig ja, men den andre forskjellen...}{0} Er at potensialet flater ut når $V(r)=1$ og ikke når $V(r)=0$ slik som før! Det betyr at det er $E/m=1$ som er grenseverdien som avgjør om legemet blir bundet eller ikke, og ikke $E/m=0$ som før. {\bf Men kan du tolke dette siste??? Hva betyr det fysisk at grensen nå går ved $E/m=1$?? Dette vet du, du må bare tenke deg om et øyeblikk!}
}



\fullframe{skra22}{skra21}{skra23}{1}{
Når $E=0$ i klassisk fysikk så betyr det at
\[
E=\frac{1}{2}mv^2-G\frac{mM}{r}=0
\]
Men hvis dette er oppfylt, hva blir da $E/m$ i relativitetsteorien?? Der har vi jo et annet uttrykk for $E/m$!\pagequestion{skra22b}{Aha, tror jeg ser det!}{-2}
...
\fullframe{skra25}{skra24b}{skra26}{0}{
\centerline{\includegraphics[scale=0.13]{skraplan7.png}}
Synes du det er overraskende at legemet må ha {\bf stor nok energi} altså energi større enn $E_\mathrm{crit}$ for å kunne bli slukt av det sort hullet?\pagequestion{skra25b}{Joa, litt rart er det vel!}{-1} Årsaken kan enkelt sies av hvis energien er lav så vil spinnet dra legemet rundt det sorte hullet og sende det ut igjen (hvis $E/m>1$) men hvis energien er høy nok til å overvinne effekten av spinnet, så kan det komme innenfor $r_\mathrm{crit}$.
}
...
\centerline{\includegraphics[scale=0.1]{skraplan7.png}}
Men la oss først gjøre oss litt kjent med uttrykket.
\[
V_\mathrm{eff}(r)=\sqrt{\left[1+\left(\frac{L/m}{r}\right)^2\right]\sst}
\]
{\bf Uten å gjøre noe regning, har du noen formening om hva $r$-verdien for toppen av potensialet er???} Altså ved hvilken verdi for $r_\mathrm{crit}$ er toppen i potensialet $V(r)$ slik at hvis klossen/legemet kommer over denne toppen vil legemet falle ned ``bakken'' og inn i det sorte hullet?\\
\hyperlink{skra29}{\choicebutton{$r_\mathrm{crit}=M$}}\hyperlink{skra28}{\choicebutton{$r_\mathrm{crit}=2M$}}\hyperlink{skra29}{\choicebutton{$r_\mathrm{crit}=3M$}}\hyperlink{skra30}{\choicebutton{Ingen aning!}}\\
}


\colfullframe{skra28}{skra27}{skra30}{0}{black}{\Huge
\textcolor{yellow}{
HAH! Lurte deg! Svaret er NEI, $r>2M$!!! Kan du tenke deg hvorfor?}
}

\colfullframe{skra29}{skra27}{skra30}{-1}{black}{\Huge
\textcolor{yellow}{
Hvordan kom du frem til det? Det er galt...}
}

\colfullframe{skra30}{skra27}{skra31}{-1}{yellow}{\Large
...
\fullframe{skra31}{skra30}{skra32}{0}{\Large
...
\fullframe{skra34}{skra33}{skra35}{0}{\Huge
...
\centerline{\includegraphics[scale=0.13]{skraplan8.png}}
...
\centerline{\includegraphics[scale=0.13]{skraplan8.png}}
I \href{https://www.uio.no/studier/emner/matnat/astro/AST2000/h20/undervisningsmateriell/interaktive-forelesningsnotater/2d_og_2e/videoer/video2d_6.mp4}{denne videoen} diskutere jeg hvordan Merkurs bane blir seende ut basert på det vi vet om potensialet $V(r)$.
}


\fullframe{skra36}{skra35b}{nytema4}{0}{
...
\fullframe{skra37}{skra36}{skra38}{0}{\label{lys}\Huge
Hva så med lys? Kan de også følge baner nå som de også blir påvirket av gravitasjon?
}

\fullframe{skra38}{skra37}{skra39}{0}{\Huge
...
\fullframetxt{skra39}{skra38}{skra40}{0}{Ja hvordan gjør vi det?}{\huge
...
\fullframetxt{skra41}{skra40}{skra42}{0}{gir oss...}{\large
Husker du sammenhengen (det bør du!) mellom langt-vekk og skall-koordinater?\pagequestion{skra41b}{Jaaaaaa....joda.....vel...}{-1}
...
\centerline{\includegraphics[scale=0.15]{skraplan9.png}}
...
\centerline{\includegraphics[scale=0.1]{skraplan9.png}}
Fra likningen
\[
...
\hyperlink{skra45}{\choicebutton{Jeg ser tydelig fra figuren at lys kan ha stabile baner!}}\\
\hyperlink{skra46}{\choicebutton{TULL, det går ikke an for lys å ha stabile baner!}}
}


\colfullframe{skra45}{skra44}{skra46}{0}{black}{\large
...
\colfullframe{skra46}{skra44}{skra47}{-1}{yellow}{\large
...
\fullframe{skra47}{skra46}{skra48}{0}{\large
\centerline{\includegraphics[scale=0.1]{skraplan9.png}}
...
\fullframe{skra48}{skra47}{skra49}{0}{\huge
...
\colfullframe{skra49}{skra48}{oppsummering}{0}{black}{\textcolor{yellow}{\footnotesize
...
\centerline{\includegraphics[scale=0.3]{gravlens.png}}
...
\begin{frame}
\label{oppsummering}
\hyperlink{skra49}{\pagebutton{\small Forrige side}}\href{https://nettskjema.no/a/173961}{\Changey[1][yellow]{2} \Changey[1][yellow]{-2}}
