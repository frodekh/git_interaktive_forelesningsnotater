...
\item \hyperlink{riktig_eu17b}{\headlinebutton{Relativistisk Euler: eksempel}}
...
\fullframenotxt{eu5}{eu4}{eu6}{0}{\Large
Fikk du
\[
...
\fullframe{eu5_b}{eu4}{eu6}{0}{\Large
Fikk du
\[
\Delta t=\frac{E/m}{1-\frac{2M}{r}}\Delta\tau
\]
...
Hva med endringen i vinkel, $\Delta\phi$?? Kan du se hvordan den må oppdateres for et gitt egentidsintervall $\Delta\tau$...?
\hyperlink{eu7}{\pagebutton{Jepp, jeg har uttrykket klart!}}   {\pagebutton{Et hint kanskje?}}\\
Ta en kikk på den førstesiden med formler igjen!
}{SIDE 8/31/84}
...
\]
{\Huge ???}
\hyperlink{eu17}{\pagebutton{Dette fikk jeg til, gå videre!}}\\  {\pagebutton{Kom ikke helt imål, hint?}}
...
\colfullframe{riktig_eu17b}{eu17}{denim_eu17c}{0}{denim}{\textcolor{yellow}{\small
...
\colfullframenotxt{denim_eu17c}{riktig_eu17b}{denim_eu17d}{0}{denim}{\textcolor{yellow}{\footnotesize
{\large
\[
\Delta r=\pm \sst\sqrt{1-\sst\frac{(L/E)^2}{r^2}}\Delta t
\]
...
\colfullframenotxt{denim_eu17c_b}{riktig_eu17b}{denim_eu17d}{0}{denim}{\textcolor{yellow}{\footnotesize
{\large
\[
\Delta r=\pm \sst\sqrt{1-\sst\frac{(L/E)^2}{r^2}}\Delta t
\]
...
\colfullframenotxt{denim_eu17c_c}{riktig_eu17b}{denim_eu17d}{0}{denim}{\textcolor{yellow}{\footnotesize
{\large
\[
\Delta r=\pm \sst\sqrt{1-\sst\frac{(L/E)^2}{r^2}}\Delta t
\]
...
\colfullframenotxt{denim_eu17c_d}{riktig_eu17b}{denim_eu17d}{0}{denim}{\textcolor{yellow}{\footnotesize
{\large
\[
\Delta r=\pm \sst\sqrt{1-\sst\frac{(L/E)^2}{r^2}}\Delta t
\]
...
\colfullframenotxt{denim_eu17c_e}{riktig_eu17b}{denim_eu17d}{0}{denim}{\textcolor{yellow}{\footnotesize
{\large
\[
\Delta r=\pm \sst\sqrt{1-\sst\frac{(L/E)^2}{r^2}}\Delta t
\]
...
\colfullframetxt{denim_eu17c_f}{riktig_eu17b}{denim_eu17d}{0}{denim}{\footnotesize NEI, VIL IKKE!}{\textcolor{yellow}{\footnotesize
{\large
\[
\Delta r=\pm \sst\sqrt{1-\sst\frac{(L/E)^2}{r^2}}\Delta t
\]
...
\colfullframenotxt{denim_eu17d}{denim_eu17c}{denim_eu17h}{1}{denim}{\textcolor{yellow}{
\centerline{\includegraphics[scale=0.2]{media/radvel.png}}
{\large
\[
v_r=\sst
...
\colfullframe{denim_eu17d_b}{denim_eu17c}{denim_eu17h}{1}{denim}{\textcolor{yellow}{
\centerline{\includegraphics[scale=0.2]{media/radvel.png}}
{\large
\[
v_r=\sst
...
r\frac{d\phi}{dt}&=\pm\frac{b}{r}\sst.
\end{align*}
Merk at vi nå har gjort $\Delta$-ene infinitesimalt små slik at de har blitt til $d$-er. Merk også at vi har $rd\phi/dt$ på venstre side isteden for bare $d\phi/dt$, kan du se hvorfor? {\pagebutton{Njaaaa, kanskje.}} Husker du at vi i celestmekanikken fant at tangensialhastighet er $v_\phi=r\dot{\phi}$? Ja, det er nettopp den du har på venstre side nederst! Og øverst har du radiell hastighet til lyset. {\bf Alt sett fra langt-vekkobservatøren selvfølgelig!}
}{SIDE 30/31/84}
...
\fullframenotxt{skra10}{skra9}{skra11}{0}{\label{effpot}\small
...
\fullframetxt{skra10_b}{skra9}{skra11}{0}{Tjaaaa......ikke helt rett frem det der nei...}{\label{effpot}\small
...
\vec{v}=v_r\vec{e}_r+v_\theta\vec{e}_\theta
\]
men hva er $v_r$ og $v_\theta$ her? Uttrykk svaret med størrelsene $r$ og $\theta$ og deres tidsderiverte.{\pagebutton{Dette bare {\bf må} jeg få til, la meg tenke litt...}} Fikk du...\hyperlink{skra11_c}{\pagebutton{ja, jeg fikk...}}\textcolor{white}{
\[
\vec{v}=\dot{r}\vec{e}_r+r\dot{\theta}\vec{e}_\theta
\]
og vet nøyaktig hvordan jeg kommer frem til dette. {\bf Hvis ikke så kikker jeg på {Del 1B} for å se hvordan man kom frem til det}. Men kan du skrive $v_\theta$ her ut med $h$ som er spinn per masse?}
...
\vec{v}=v_r\vec{e}_r+v_\theta\vec{e}_\theta
\]
men hva er $v_r$ og $v_\theta$ her? Uttrykk svaret med størrelsene $r$ og $\theta$ og deres tidsderiverte.{\pagebutton{Dette bare {\bf må} jeg få til, la meg tenke litt...}} Fikk du...{\pagebutton{ja, jeg fikk...}}
\[
\vec{v}=\dot{r}\vec{e}_r+r\dot{\theta}\vec{e}_\theta
\]
...
Fikk du det til? Hvis ikke gi det et par forsøk til!\hyperlink{red_skra18_b}{\pagebutton{Et lite hint kan du få!}}}\textcolor{red}{
Du trenger kun
\[
\frac{dr}{d\tau}=\pm\sqrt{\left(\frac{E}{m}\right)^2-\left(1+\left(\frac{L/m}{r}\right)^2\right)\sst}
\]}
...
\textcolor{yellow}{{\Huge
Fikk du det til? Hvis ikke gi det et par forsøk til!{\pagebutton{Et lite hint kan du få!}}}
Du trenger kun
\[
\frac{dr}{d\tau}=\pm\sqrt{\left(\frac{E}{m}\right)^2-\left(1+\left(\frac{L/m}{r}\right)^2\right)\sst}
\]
...
\centerline{\includegraphics[scale=0.13]{media/skraplan7.png}}
Forskjellene er...{\pagebutton{\footnotesize ...jeg har det...}}
...
E=\frac{1}{2}mv^2-G\frac{mM}{r}=0
\]
Men hvis dette er oppfylt, hva blir da $E/m$ i relativitetsteorien?? Der har vi jo et annet uttrykk for $E/m$!{\pagebutton{Aha, tror jeg ser det!}}
For svake tyngdefelt og lave hastigheter fant vi jo i del 2C at
\[
E\approx\frac{1}{2}mv^2-G\frac{mM}{r}\mathbf{+mc^2}
\]
...
\centerline{\includegraphics[scale=0.13]{media/skraplan7.png}}
Synes du det er overraskende at legemet må ha {\bf stor nok energi} altså energi større enn $E_\mathrm{crit}$ for å kunne bli slukt av det sort hullet?{\pagebutton{Joa, litt rart er det vel!}} Årsaken kan enkelt sies av hvis energien er lav så vil spinnet dra legemet rundt det sorte hullet og sende det ut igjen (hvis $E/m>1$) men hvis energien er høy nok til å overvinne effekten av spinnet, så kan det komme innenfor $r_\mathrm{crit}$.
}{SIDE 58/70/84}
...
Husker du sammenhengen (det bør du!) mellom langt-vekk og skall-koordinater?{\pagebutton{Jaaaaaa....joda.....vel...}}
På diffensialform (altså med $d$-er istedenfor $\Delta$):
\[
dr_\mathrm{sh}=\frac{dr}{\sqrt{\sst}}
\]
