...
\begin{frame}
\label{front}
\center{\Large \textcolor{darkscarlet}{\bf AST2000 Del 2A forlesning 1 av 2\\Interaktive forelesningsnotater}}\\
\vspace*{1cm}
...
\column{0.5\textwidth}
{\small
{\bf Velkommen til forelesning 1 av 2 i del 2A! Vi begynner med den spesielle relativitetsteorien. Hovedfokuset her er å prøve å få en viss forståelse for hva som skjer. Matematikken i del 2A blir holdt på et veldig enkelt nivå mens forståelsen og intuisjonen for hovedprinsippene i relativitetsteorien skal spille hovedrollen. Dette blir også det som forventes av deg i rapport/bloggskriving (prosjekt) og på eksamen (standardløp). Vi begynner forsiktig med den klassiske relativitetsteorien...}\\
...
\href{https://nettskjema.no/a/170169}{\choicebutton{Nei}}\ \ \ \ \hyperlink{brainstormdone}{\choicebutton{Ja}}\\
...
\centerline{\includegraphics[scale=0.3]{klassrel1.png}}
{\small
...
\centerline{\includegraphics[scale=0.3]{klassrel2.png}}
{\small
...
\hyperlink{kr2a}{\choicebutton{-100 km/t}}\hyperlink{kr2a}{\choicebutton{-50 km/t}}\hyperlink{kr2a}{\choicebutton{0 km/t}}\hyperlink{kr2b}{\choicebutton{50 km/t}}\hyperlink{kr2a}{\choicebutton{100 km/t}}
}
}

\colchoiceframe{kr2a}{kr2}{0}{black}{\Huge
...
\colfullframe{kr2b}{kr2}{kr3}{-1}{yellow}{\huge
\centerline{\includegraphics[scale=0.3]{klassrel3.png}}
Det er helt riktig! Brukte du intuisjon eller fant du en formel/sammenheng mellom de to hastighetene?
}


\choiceframe{kr3}{kr2b}{0}{
\centerline{\includegraphics[scale=0.3]{klassrel4.png}}
{\small
...
\hyperlink{kr3a}{\choicebutton{-100 km/t}}\hyperlink{kr3a}{\choicebutton{-50 km/t}}\hyperlink{kr3b}{\choicebutton{0 km/t}}\hyperlink{kr3a}{\choicebutton{50 km/t}}\hyperlink{kr3a}{\choicebutton{100 km/t}}
}
}


\colchoiceframe{kr3a}{kr3}{0}{black}{\Huge
...
\colfullframe{kr3b}{kr3}{kr4}{-1}{yellow}{\Large
\centerline{\includegraphics[scale=0.3]{klassrel5.png}}
...
\choiceframe{kr4}{kr3b}{0}{
\centerline{\includegraphics[scale=0.3]{klassrel6.png}}
{\small
...
\hyperlink{kr4a}{\choicebutton{-150 km/t}}\hyperlink{kr4b}{\choicebutton{-50 km/t}}\hyperlink{kr4a}{\choicebutton{0 km/t}}\hyperlink{kr4a}{\choicebutton{50 km/t}}\hyperlink{kr4a}{\choicebutton{150 km/t}}
}
}

\colchoiceframe{kr4a}{kr4}{0}{black}{\huge
...
\colfullframe{kr4b}{kr4}{kr5}{-1}{yellow}{\Large
\centerline{\includegraphics[scale=0.3]{klassrel7.png}}
Det er helt riktig! Brukte du intuisjon eller fant du en formel/sammenheng mellom de to hastighetene? Var det samme sammenheng som i forrige spørsmål?
}


\fullframe{kr5}{kr4b}{kr6}{0}{
\centerline{\includegraphics[scale=0.3]{klassrel7.png}}
{\small
...
\centerline{\includegraphics[scale=0.55]{fig_7-3.pdf}}
...
\hyperlink{kr8b}{\choicebutton{c - 30km/s}}\hyperlink{kr8a}{\choicebutton{\ \ c\ \ }}\hyperlink{kr8a}{\choicebutton{c + 30km/s}}
}

\colchoiceframe{kr8a}{kr8}{0}{black}{\large
...
\colfullframe{kr8b}{kr8}{kr9}{-1}{yellow}{
\centerline{\includegraphics[scale=0.55]{fig_7-3.pdf}}
Det er helt riktig!
\[
...
\centerline{\includegraphics[scale=0.3]{klassrel8.png}}
...
\centerline{\includegraphics[scale=0.3]{klassrel9.png}}
...
\centerline{\includegraphics[scale=0.3]{klassrel10.png}}
...
\centerline{\includegraphics[scale=0.3]{klassrel11.png}}
...
\centerline{\includegraphics[scale=0.3]{tog1.png}}
...
\hyperlink{tog4a}{\choicebutton{P ser begge samtidig}}\hyperlink{tog4b}{\choicebutton{P ser A før B}}\hyperlink{tog4a}{\choicebutton{P ser B før A}}
}

\colchoiceframe{tog4a}{tog4}{0}{black}{\large
...
\colfullframetxt{tog4b}{tog4}{tog5}{-1}{yellow}{Ok, slik må det være!}{
\centerline{\includegraphics[scale=0.26]{tog1.png}}
...
\fullframe{tog5}{tog4b}{tog6}{0}{
\centerline{\includegraphics[scale=0.26]{tog2.png}}
...
\centerline{\includegraphics[scale=0.26]{tog3.png}}
...
\centerline{\includegraphics[scale=0.26]{tog1.png}}
Hva stemmer? \hyperlink{tog8a}{\choicebutton{\small $t_c=L/2, \ \ t_D=L/2$}} \hyperlink{tog8a}{\choicebutton{\small $t_c=L/(2v) - v/c, \ \ t_D=L/(2v) + v/c$}}\\
\hyperlink{tog8a}{\choicebutton{\small $t_c=L\sqrt{1-(v/c)^2}/v,\ \ t_D=L/\sqrt{1-(v/c)^2}/v$}}\\
\hyperlink{tog8b}{\choicebutton{\small $t_c=L/2/(c+v), \ \ t_D=L/2/(c-v)$}}\hyperlink{tog8a}{\choicebutton{\small $t_c=L/2/c, \ \ t_D=L/2/v$}}\\
\hyperlink{tog8a}{\choicebutton{\small $t_c=(L-v)/2/c, \ \ t_D=(L+v)/2/c$}}
}

\colchoiceframe{tog8a}{tog8}{0}{black}{\large
...
\colfullframe{tog8b}{tog8}{pause}{-1}{yellow}{
\centerline{\includegraphics[scale=0.26]{tog1.png}}
...
\begin{frame}
\label{pause}
\hyperlink{tog8b}{\pagebutton{\small Forrige side}}
{\huge
\centerline{Kaffe?}
...
\centerline{\includegraphics[scale=0.26]{tog4.png}}
...
\hyperlink{tog11b}{\choicebutton{P ser begge samtidig}}\hyperlink{tog11a}{\choicebutton{P ser A før B}}\hyperlink{tog11a}{\choicebutton{P ser B før A}}
}


\colchoiceframe{tog11a}{tog11}{0}{black}{\large
...
\colfullframetxt{tog11b}{tog11}{tog12}{-1}{yellow}{Joa...}{
\centerline{\includegraphics[scale=0.26]{tog1.png}}
...
\choiceframe{tog12}{tog11b}{0}{
\centerline{\includegraphics[scale=0.26]{tog5.png}}
Når skjer event C og D? Hvor lang tid tar det for strålene å nå passasjer P?\\
\hyperlink{tog12a}{\choicebutton{\small $t_c=t_D=L\sqrt{1-(v/c)^2}/v$}}\\
\hyperlink{tog12a}{\choicebutton{\small $t_c=t_D=L/2/(c+v)$}}\hyperlink{tog12b}{\choicebutton{\small $t_c=t_D=L/2/c$}}\\
\hyperlink{tog12a}{\choicebutton{\small $t_c=t_D=(L-v)/2/c$}}
}


\colchoiceframe{tog12a}{tog12}{0}{black}{\large
...
\colfullframe{tog12b}{tog12}{tog13}{-1}{yellow}{
\centerline{\includegraphics[scale=0.26]{tog5.png}}
...
\fullframe{tog13}{tog12b}{tog14}{0}{\Huge
...
\centerline{\includegraphics[scale=0.4]{samtale1.png}}
}

\colfullframe{tog16}{tog15}{tog17}{0}{silver}{
\centerline{\includegraphics[scale=0.4]{samtale2.png}}
}

\colfullframe{tog17}{tog16}{tog18}{0}{silver}{
\centerline{\includegraphics[scale=0.4]{samtale3.png}}
}

\colfullframe{tog18}{tog17}{tog19}{0}{silver}{
\centerline{\includegraphics[scale=0.4]{samtale4.png}}
}
