...
\end{itemize}
{\bf Var det slik du forestilte deg det?} Hvis du sliter med å se det, ta kontakt med foreleser (eller padlet over!)\\
...
\fullframetwo{eks11}{eks10}{eks11x}{0}{\footnotesize
...
\centerline{\includegraphics[scale=0.26]{media/tog7.png}}
Vi har tre ukjent, $L_0$, $t_A'$ og $t_B'$, og trenger dermed tre likninger for å kunne finne disse. Vi vet nå at vi har en superviktig informasjon: tidromsintervallet er den samme i alle referansesystemer. Det vil si at $\Delta s$ er den samme i merket og umerket system for alle kombinasjoner av avstander mellom eventer. Ta nå utgangspunkt i avstanden mellom eventene A og B, sett opp invarians av tidromsintervallet og se om du kan komme frem til at:
\[
L^2=L_0^2-(t_A'-t_B')^2
\]
...
\fullframe{tog14}{tog13}{tog15}{0}{\footnotesize
...
\end{align}
Sett inn for L i likning (3) fra likning (2). Da skulle du få to mulige løsninger for $t_A'$. Hvilke?\pagequestion{tog14b}{\small Wow, det blir litt lang regning...}{-1}
Fikk du:
\begin{align*}
t_A'&=-L_0/2\\
t_A'&=-vL_0/2
